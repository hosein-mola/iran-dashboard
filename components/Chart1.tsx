...
export function Chart1() {
  ...
  return (
    <Card className="rounded-none shadow-none" dir="rtl">
      <CardHeader className="col-span-3 flex items-center gap-2 space-y-0 border-b sm:flex-row">
        ...
        <Select value={timeRange} onValueChange={setTimeRange}>
          <SelectTrigger
            dir="rtl"
            className="w-[160px] rounded-none text-right sm:mr-auto"
          ...
          <SelectContent className="rounded-none shadow-2xl shadow-blue-200">
            ...
            <SelectItem value="30d" className="rounded-none text-right">
              ۳۰ روز گذشته
            </SelectItem>
            <SelectItem value="7d" className="rounded-none text-right">
              ۷ روز گذشته
            </SelectItem>
          </SelectContent>
        </Select>
