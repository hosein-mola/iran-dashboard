...
var { OR, POSITIVE_NUMBER, NAN, AxisInterval, TempValidate } = _ModuleSupport;
...
// packages/ag-charts-enterprise/src/axes/angle-category/angleCategoryAxis.ts
var { RATIO: RATIO2, OBJECT: OBJECT2, TempValidate: TempValidate4, CategoryScale } = _ModuleSupport5;
...
// packages/ag-charts-enterprise/src/axes/radius-category/radiusCategoryAxis.ts
var { RATIO: RATIO3, ProxyPropertyOnWrite, TempValidate: TempValidate8, CategoryScale: CategoryScale2 } = _ModuleSupport11;
...
var { AND: AND3, GREATER_THAN: GREATER_THAN2, LESS_THAN: LESS_THAN2, NUMBER_OR_NAN: NUMBER_OR_NAN2, TempValidate: TempValidate9, normalisedExtentWithMetadata: normalisedExtentWithMetadata2, LinearScale: LinearScale2 } = _ModuleSupport12;
...
var { Chart, TempValidate: TempValidate10, ARRAY: ARRAY2 } = _ModuleSupport14;
...
var GEOJSON_OBJECT = _ModuleSupport22.predicateWithMessage(isValidFeatureCollection, "a GeoJSON object");

// packages/ag-charts-enterprise/src/charts/topologyChart.ts
var { Chart: Chart5, MercatorScale, NumberAxis, TempValidate: TempValidate11 } = _ModuleSupport23;
...
// packages/ag-charts-enterprise/src/charts/topologyChartModule.ts
var { isAgTopologyChartOptions, topologyChartOptionsDefs } = _ModuleSupport24;
...
import {
  _ModuleSupport as _ModuleSupport25
...
var { toolbarButtonOptionsDefs } = _ModuleSupport25;
...
annotationOptionsDef.xKey = string2;
annotationOptionsDef.volumeKey = string2;
annotationOptionsDef.snap = boolean2;
var serializableDate = optionsDefs(
  {
    __type: required2(constant2("date")),
    value: or2(string2, number2)
  },
  "a serializable date object"
);
var xValue = or2(string2, number2, serializableDate);
var annotationValue = or2(
  xValue,
  optionsDefs({
    value: xValue,
    groupPercentage: number2
  })
);
...
var lineAnnotationTextOptionsDef = {
  label: string2,
  position: union2("top", "center", "bottom"),
  alignment: union2("left", "center", "right"),
  ...fontOptionsDef2
};
var channelAnnotationTextOptionsDef = {
  label: string2,
  position: union2("top", "inside", "bottom"),
  alignment: union2("left", "center", "right"),
  ...fontOptionsDef2
};
...
var annotationLineOptionsDef = {
  lineStyle: union2("solid", "dashed", "dotted"),
  ...lineDashOptionsDef
};
var fibonacciAnnotationStylesOptionsDef = {
  visible: boolean2,
  extendStart: boolean2,
  extendEnd: boolean2,
  locked: boolean2,
...
var annotationInitialStateOptionsDef = typeUnion({
  ...
  "disjoint-channel": {
    ...
    extendEnd: boolean2,
    locked: boolean2,
    startHeight: positiveNumber2,
    endHeight: positiveNumber2,
  ...
  "date-range": {
    visible: boolean2,
    extendAbove: boolean2,
    extendBelow: boolean2,
    locked: boolean2,
    text: lineAnnotationTextOptionsDef,
    handle: annotationHandleOptionsDef,
    start: annotationPointOptionsDef,
...
var initialStateOptionsDef = {
  ...
  zoom: {
    rangeX: {
      start: or2(number2, serializableDate),
      end: or2(number2, serializableDate)
    },
    rangeY: {
      start: or2(number2, serializableDate),
      end: or2(number2, serializableDate)
    ...
    autoScaledAxes: arrayOf(constant2("y"))
  }
};
...
var { ScalableGroup, Rect, Line: Line2, BBox: BBox2, Selection: Selection2, applyShapeFillBBox } = _ModuleSupport26;
var BoxPlotGroup = class extends ScalableGroup {
  ...
  distanceSquared(x, y) {
    ...
    return _ModuleSupport26.nearestSquared(x, y, nodes).distanceSquared;
  }
  get midPoint() {
...
var BoxPlotSeriesNodeEvent = class extends _ModuleSupport28.SeriesNodeEvent {
...
var BoxPlotSeries = class extends _ModuleSupport28.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
...
var { commonSeriesOptionsDefs, tooltipOptionsDefs } = _ModuleSupport29;
var boxPlotSeriesOptionsDef = {
  type: required3(constant3("box-plot")),
  xKey: required3(string3),
  minKey: required3(string3),
  q1Key: required3(string3),
  medianKey: required3(string3),
  q3Key: required3(string3),
  maxKey: required3(string3),
  xName: string3,
  yName: string3,
  minName: string3,
  q1Name: string3,
...
var { CARTESIAN_AXIS_TYPE } = _ModuleSupport30.ThemeConstants;
  ...
  series: {
    ...
    fill: {
      $if: [
        ...
        { $palette: "fill" },
        { $mix: [_ModuleSupport30.SAFE_FILL_OPERATION, { $ref: "backgroundColor" }, 0.7] }
      ]
    },
    ...
    fillPatternDefaults: _ModuleSupport30.FILL_PATTERN_DEFAULTS,
    strokeWidth: 2
  },
  axes: {
...
var BoxPlotModule = {
  ...
  defaultAxes: _ModuleSupport31.DIRECTION_SWAP_AXES,
...
import {
  _ModuleSupport as _ModuleSupport33
} from "ag-charts-community";
...
var { findMinMax: findMinMax2 } = _ModuleSupport32;
var X_MIN = 0;
var X_MAX = 1;
var Y_MIN = 2;
var Y_MAX = 3;
...
var OhlcSeriesNodeEvent = class extends _ModuleSupport33.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var OhlcSeriesBase = class extends _ModuleSupport33.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
...
var { Path: Path5, ScenePathChangeDetection, BBox: BBox3 } = _ModuleSupport34;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickNode.ts
var { ScenePathChangeDetection: ScenePathChangeDetection2, ExtendedPath2D, BBox: BBox4 } = _ModuleSupport35;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeries.ts
var { createDatumId: createDatumId3, isGradientFill: isGradientFill2, isPatternFill, applyShapeFillBBox: applyShapeFillBBox2, getShapeFill, getShapeStyle: getShapeStyle3 } = _ModuleSupport38;
...
import {
  _ModuleSupport as _ModuleSupport39
} from "ag-charts-community";
import {
  boolean as boolean4,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs2, tooltipOptionsDefs: tooltipOptionsDefs2 } = _ModuleSupport39;
...
var candlestickSeriesOptionsDef = {
  type: required4(constant4("candlestick")),
  ...
  itemStyler: callback4,
  showInMiniChart: boolean4,
  tooltip: tooltipOptionsDefs2,
  ...commonSeriesOptionsDefs2
};
candlestickSeriesOptionsDef.pickOutsideVisibleMinorAxis = boolean4;
candlestickSeriesOptionsDef.focusPriority = number3;
...
var { CARTESIAN_AXIS_TYPE: CARTESIAN_AXIS_TYPE2 } = _ModuleSupport40.ThemeConstants;
function itemTheme(key) {
  return {
    ...
    fillPatternDefaults: _ModuleSupport40.FILL_PATTERN_DEFAULTS
  };
}
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickModule.ts
var { CARTESIAN_AXIS_TYPE: CARTESIAN_AXIS_TYPE3, CARTESIAN_POSITION } = _ModuleSupport41.ThemeConstants;
...
var { CachedTextMeasurerPool, TextUtils: TextUtils2, TextWrapper: TextWrapper2 } = _ModuleSupport42;
...
var { TempValidate: TempValidate15, NUMBER: NUMBER5, POSITIVE_NUMBER: POSITIVE_NUMBER6, TEXT_WRAP, OVERFLOW_STRATEGY } = _ModuleSupport43;
var BaseAutoSizedLabel = class extends _ModuleSupport43.Label {
  constructor() {
    super(...arguments);
...
var HeatmapSeriesNodeEvent = class extends _ModuleSupport45.CartesianSeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var HeatmapSeries = class extends _ModuleSupport45.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs3, autoSizedLabelOptionsDefs, tooltipOptionsDefs: tooltipOptionsDefs3 } = _ModuleSupport46;
var heatmapSeriesOptionsDef = {
  type: required5(constant5("heatmap")),
  ...
  yName: string5,
  colorName: string5,
  colorRange: arrayOf2(color2),
  title: string5,
  textAlign: union4("left", "center", "right"),
  verticalAlign: union4("top", "middle", "bottom"),
  itemPadding: positiveNumber5,
  itemStyler: callback5,
  ...
  series: {
    ...
    colorRange: {
      $if: [
        ...
        _ModuleSupport47.SAFE_RANGE2_OPERATION
      ]
    },
    label: {
      enabled: false,
...
var { createDatumId: createDatumId5 } = _ModuleSupport49;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs4, tooltipOptionsDefs: tooltipOptionsDefs4 } = _ModuleSupport50;
var ohlcSeriesItemOptionsDef = {
  ...strokeOptionsDef5,
  ...lineDashOptionsDef4
};
var ohlcSeriesOptionsDef = {
  type: required6(constant6("ohlc")),
  xKey: required6(string6),
  openKey: required6(string6),
  highKey: required6(string6),
  lowKey: required6(string6),
  closeKey: required6(string6),
  xName: string6,
  yName: string6,
  openName: string6,
  highName: string6,
...
ohlcSeriesOptionsDef.pickOutsideVisibleMinorAxis = boolean6;
ohlcSeriesOptionsDef.focusPriority = number4;

// packages/ag-charts-enterprise/src/series/ohlc/ohlcModule.ts
var { CARTESIAN_AXIS_TYPE: CARTESIAN_AXIS_TYPE5, CARTESIAN_POSITION: CARTESIAN_POSITION3 } = _ModuleSupport51.ThemeConstants;
var OhlcModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var RangeAreaSeriesNodeEvent = class extends _ModuleSupport54.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var RangeAreaSeries = class extends _ModuleSupport54.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      hasMarkers: true,
      pathsPerSeries: ["fill", "stroke"],
      pickModes: [_ModuleSupport54.SeriesNodePickMode.AXIS_ALIGNED],
      directionKeys: {
...
var rangeAreaSeriesOptionsDef = {
  type: required7(constant7("range-area")),
  ...
  connectMissingData: boolean7,
  interpolation: interpolationValidator,
  label: {
    ...seriesLabelOptionsDefs,
    padding: positiveNumber6,
    placement: union5("inside", "outside")
  },
...
rangeAreaSeriesOptionsDef.pickOutsideVisibleMinorAxis = boolean7;
rangeAreaSeriesOptionsDef.focusPriority = number5;
...
var RangeBarSeriesNodeEvent = class extends _ModuleSupport59.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
    this.yLowKey = series.properties.yLowKey;
...
var RangeBarSeries = class extends _ModuleSupport59.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs6, seriesLabelOptionsDefs: seriesLabelOptionsDefs2, shadowOptionsDefs: shadowOptionsDefs2, tooltipOptionsDefs: tooltipOptionsDefs6 } = _ModuleSupport60;
var rangeBarSeriesOptionsDef = {
  type: required8(constant8("range-bar")),
  xKey: required8(string8),
  yLowKey: required8(string8),
  yHighKey: required8(string8),
  xName: string8,
  yName: string8,
  yLowName: string8,
  yHighName: string8,
  direction: union6("horizontal", "vertical"),
  showInMiniChart: boolean8,
  cornerRadius: positiveNumber7,
  itemStyler: callback7,
  label: {
    ...seriesLabelOptionsDefs2,
    padding: positiveNumber7,
    placement: union6("inside", "outside")
  },
...
rangeBarSeriesOptionsDef.pickOutsideVisibleMinorAxis = boolean8;
rangeBarSeriesOptionsDef.fastDataProcessing = boolean8;
rangeBarSeriesOptionsDef.focusPriority = number6;
...
var RANGE_BAR_SERIES_THEME = {
  ...
  axes: {
    [_ModuleSupport61.ThemeConstants.CARTESIAN_AXIS_TYPE.NUMBER]: {
      crosshair: { enabled: true }
    }
  }
};
...
var WaterfallSeries = class extends _ModuleSupport64.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  async processData(dataController) {
    ...
    const { processedData } = await this.requestDataModel(dataController, dataWithTotals, {
      props: [
        ...
        ...isContinuousX ? [_ModuleSupport64.SMALLEST_KEY_INTERVAL, _ModuleSupport64.LARGEST_KEY_INTERVAL] : [],
        ...extraProps
      ]
    });
    this.smallestDataInterval = processedData.reduced?.smallestKeyInterval;
  ...
  animateConnectorLinesHorizontal(opts) {
    ...
    this.ctx.animationManager.animate({
      ...
      from: startX,
      to: endX,
      ease: _ModuleSupport64.Motion.easeOut,
      collapsable: false,
      onUpdate(pointX) {
        linePath.clear(true);
  ...
  updateLineNode(lineNode) {
    ...
    lineNode.setProperties({
      ...
      lineDashOffset,
      lineJoin: "round",
      pointerEvents: _ModuleSupport64.PointerEvents.None
    });
  }
  isLabelEnabled() {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs7, seriesLabelOptionsDefs: seriesLabelOptionsDefs3, shadowOptionsDefs: shadowOptionsDefs3, tooltipOptionsDefs: tooltipOptionsDefs7 } = _ModuleSupport65;
var waterfallSeriesItemOptionsDef = {
  name: string9,
  cornerRadius: positiveNumber8,
  itemStyler: callback8,
  label: {
    ...seriesLabelOptionsDefs3,
    padding: positiveNumber8,
    placement: union7("inside-start", "inside-center", "inside-end", "outside-start", "outside-end")
  },
...
var waterfallSeriesOptionsDef = {
  type: required9(constant9("waterfall")),
  xKey: required9(string9),
  yKey: required9(string9),
  xName: string9,
  yName: string9,
  direction: union7("horizontal", "vertical"),
  totals: arrayOfDefs3(
    {
      totalType: required9(union7("total", "subtotal")),
      index: required9(positiveNumber8),
      axisLabel: required9(string9)
    },
...
function itemTheme2(key, index) {
  return {
    ...
    fillPatternDefaults: _ModuleSupport66.FILL_PATTERN_DEFAULTS,
...
var WaterfallModule = {
  ...
  tooltipDefaults: { range: "exact" },
  defaultAxes: _ModuleSupport67.DIRECTION_SWAP_AXES,
...
// packages/ag-charts-enterprise/src/series/flow-proportion/flowProportionSeries.ts
var { Series, DataController, keyProperty: keyProperty6, valueProperty: valueProperty7, Selection: Selection3, Group: Group6, TransformableText } = _ModuleSupport69;
...
var { BBox: BBox6, Path: Path6, ScenePathChangeDetection: ScenePathChangeDetection3 } = _ModuleSupport70;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs8, seriesLabelOptionsDefs: seriesLabelOptionsDefs4, tooltipOptionsDefs: tooltipOptionsDefs8 } = _ModuleSupport73;
var chordSeriesOptionsDef = {
  type: required10(constant10("chord")),
  fromKey: required10(string10),
  toKey: required10(string10),
  sizeKey: string10,
  sizeName: string10,
  fills: arrayOf4(colorUnion),
  strokes: arrayOf4(color4),
  label: {
...
var { lineDistanceSquared, BBox: BBox8, Path: Path7, ScenePathChangeDetection: ScenePathChangeDetection4 } = _ModuleSupport76;
var delta2 = 1e-6;
...
// packages/ag-charts-enterprise/src/series/cone-funnel/coneFunnelSeries.ts
var { formatValue, Line: Line3 } = _ModuleSupport80;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs9, seriesLabelOptionsDefs: seriesLabelOptionsDefs5, tooltipOptionsDefs: tooltipOptionsDefs9, without: without2 } = _ModuleSupport81;
var coneFunnelSeriesOptionsDef = {
  type: required11(constant11("cone-funnel")),
  stageKey: required11(string11),
  valueKey: required11(string11),
  direction: union8("horizontal", "vertical"),
  fills: arrayOf5(colorUnion2),
  strokes: arrayOf5(color5),
  showInMiniChart: boolean11,
  label: {
    spacing: positiveNumber11,
    placement: union8("before", "middle", "after"),
  ...
  stageLabel: {
    ...
    placement: union8("before", "after"),
    avoidCollisions: boolean11,
    itemStyler: callback11,
    format: string11,
    ...seriesLabelOptionsDefs5
  },
  tooltip: tooltipOptionsDefs9,
  ...commonSeriesOptionsDefs9,
  ...without2(fillOptionsDef8, ["fill"]),
  ...without2(strokeOptionsDef10, ["stroke"]),
  ...lineDashOptionsDef9
};
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs10, seriesLabelOptionsDefs: seriesLabelOptionsDefs6, shadowOptionsDefs: shadowOptionsDefs4, tooltipOptionsDefs: tooltipOptionsDefs10, without: without3 } = _ModuleSupport86;
var funnelSeriesOptionsDef = {
  type: required12(constant12("funnel")),
  stageKey: required12(string12),
  valueKey: required12(string12),
  direction: union9("horizontal", "vertical"),
  fills: arrayOf6(colorUnion3),
  strokes: arrayOf6(color6),
  showInMiniChart: boolean12,
  itemStyler: callback12,
  spacingRatio: ratio6,
  crisp: boolean12,
  dropOff: {
    enabled: boolean12,
  ...
  stageLabel: {
    rotation: number9,
    spacing: positiveNumber12,
    minSpacing: positiveNumber12,
  ...
  ...without3(fillOptionsDef9, ["fill"]),
  ...without3(strokeOptionsDef11, ["stroke"]),
  ...lineDashOptionsDef10
};
...
var { MARKER_SHAPE, UNION: UNION6, OR: OR10 } = _ModuleSupport89;
...
var { BaseProperties: BaseProperties8, TempValidate: TempValidate23, OBJECT: OBJECT14, BOOLEAN: BOOLEAN7, NUMBER: NUMBER7, NUMBER_ARRAY } = _ModuleSupport90;
...
var { CachedTextMeasurerPool: CachedTextMeasurerPool3, BBox: BBox9 } = _ModuleSupport92;
...
import {
  ...
  callback as callback13,
  color as color7,
  constant as constant13,
  fillOptionsDef as fillOptionsDef10,
  fontOptionsDef as fontOptionsDef4,
  gradientColorStops,
  greaterThan,
  lessThan,
  lineDashOptionsDef as lineDashOptionsDef11,
  number as number10,
  or as or3,
  ...
  string as string13,
  strokeOptionsDef as strokeOptionsDef12,
  union as union10
} from "ag-charts-core";
var {
...
var fillsOptionsDef = {
  ...
  fillMode: union10("continuous", "discrete")
};
var linearGaugeTargetOptionsDef = {
  value: required13(number10),
  text: string13,
  shape: or3(
    union10("circle", "cross", "diamond", "heart", "plus", "pin", "square", "star", "triangle", "line"),
    callback13
  ),
  placement: union10("before", "after", "middle"),
  spacing: positiveNumber13,
  size: positiveNumber13,
  rotation: number10,
  ...fillOptionsDef10,
  ...strokeOptionsDef12,
  ...lineDashOptionsDef11
};
var linearGaugeSeriesOptionsDef = {
  type: required13(constant13("linear-gauge")),
  value: required13(number10),
  direction: union10("horizontal", "vertical"),
  cornerMode: union10("container", "item"),
  cornerRadius: positiveNumber13,
  thickness: positiveNumber13,
  scale: {
    min: and(number10, lessThan("max")),
    max: and(number10, greaterThan("min")),
    label: {
      enabled: boolean13,
      formatter: callback13,
      rotation: number10,
      spacing: positiveNumber13,
      minSpacing: positiveNumber13,
      placement: union10("before", "after"),
      avoidCollisions: boolean13,
      format: numberFormatValidator3,
      ...fontOptionsDef4
    },
    interval: {
      values: arrayOf7(number10),
      step: number10
    },
    ...fillsOptionsDef,
    ...fillOptionsDef10,
  ...
  targets: arrayOfDefs4(linearGaugeTargetOptionsDef, "target options array"),
  segmentation: {
    enabled: boolean13,
    spacing: positiveNumber13,
    interval: {
...
linearGaugeSeriesOptionsDef.margin = number10;
linearGaugeSeriesOptionsDef.defaultColorRange = arrayOf7(color7);
...
linearGaugeSeriesOptionsDef.scale.defaultFill = color7;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          ...
          _ModuleSupport95.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        ...
        stroke: { $path: ["./2", _ModuleSupport95.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        label: {
          spacing: 11
        }
...
var { LonLatBBox } = _ModuleSupport96;
...
// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
var { Path: Path8, ExtendedPath2D: ExtendedPath2D2, BBox: BBox11, ScenePathChangeDetection: ScenePathChangeDetection5 } = _ModuleSupport97;
...
var TopologySeriesProperties = class extends _ModuleSupport98.SeriesProperties {
};
var TopologySeries = class extends _ModuleSupport98.DataModelSeries {
...
var MapLineSeries = class extends TopologySeries {
  ...
  updatePlacedLabelData(labelData) {
    this.labelSelection = this.labelSelection.update(labelData, (text) => {
      text.pointerEvents = _ModuleSupport100.PointerEvents.None;
    });
    this.updateLabelNodes({ labelSelection: this.labelSelection });
  }
  updateLabelNodes(opts) {
...
import {
  ...
  arrayLength,
  arrayOf as arrayOf8,
  callback as callback14,
  color as color8,
  constant as constant14,
  lineDashOptionsDef as lineDashOptionsDef12,
  object,
  positiveNumber as positiveNumber14,
  required as required14,
  string as string14,
  strokeOptionsDef as strokeOptionsDef13
} from "ag-charts-core";
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs12, seriesLabelOptionsDefs: seriesLabelOptionsDefs8, tooltipOptionsDefs: tooltipOptionsDefs12 } = _ModuleSupport101;
var mapLineSeriesOptionsDef = {
  type: required14(constant14("map-line")),
  idKey: required14(string14),
  sizeKey: string14,
  colorKey: string14,
  labelKey: string14,
  idName: string14,
  ...
  maxStrokeWidth: positiveNumber14,
  title: string14,
  itemStyler: callback14,
  sizeDomain: arrayOf8(positiveNumber14),
  label: seriesLabelOptionsDefs8,
  tooltip: tooltipOptionsDefs12,
  ...commonSeriesOptionsDefs12,
  ...strokeOptionsDef13,
  ...lineDashOptionsDef12,
  highlightStyle: {
    ...commonSeriesOptionsDefs12.highlightStyle,
    ...strokeOptionsDef13
  }
};
mapLineSeriesOptionsDef.colorRange = and2(arrayOf8(color8), arrayLength(1));
...
var MapLineModule = {
  ...
  themeTemplate: {
    ...MAP_THEME_DEFAULTS,
    series: {
      stroke: _ModuleSupport102.SAFE_STROKE_FILL_OPERATION,
      // @ts-expect-error undocumented option
      colorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
...
var { COLOR_STRING: COLOR_STRING14, LINE_DASH: LINE_DASH13, OBJECT: OBJECT17, POSITIVE_NUMBER: POSITIVE_NUMBER16, RATIO: RATIO16, TempValidate: TempValidate26, SeriesProperties: SeriesProperties4, SeriesTooltip: SeriesTooltip13 } = _ModuleSupport103;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundSeries.ts
var { createDatumId: createDatumId14, SeriesNodePickMode: SeriesNodePickMode10, Group: Group9, Selection: Selection7, PointerEvents: PointerEvents6 } = _ModuleSupport104;
...
import "ag-charts-community";
import { constant as constant15, lineDashOptionsDef as lineDashOptionsDef13, object as object2, required as required15, strokeOptionsDef as strokeOptionsDef14 } from "ag-charts-core";
var mapLineBackgroundSeriesOptionsDef = {
  type: required15(constant15("map-line-background")),
  topology: object2,
  ...strokeOptionsDef14,
  ...lineDashOptionsDef13
};
...
var { BBox: BBox12 } = _ModuleSupport106;
...
import {
  ...
  fillOptionsDef as fillOptionsDef11,
  object as object3,
  positiveNumber as positiveNumber15,
  required as required16,
  string as string15,
  strokeOptionsDef as strokeOptionsDef15,
  union as union11
} from "ag-charts-core";
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs13, markerOptionsDefs: markerOptionsDefs2, seriesLabelOptionsDefs: seriesLabelOptionsDefs9, tooltipOptionsDefs: tooltipOptionsDefs13, without: without4 } = _ModuleSupport109;
var mapMarkerSeriesOptionsDef = {
  type: required16(constant16("map-marker")),
  // TODO idKey OR latitudeKey & longitudeKey should be required - support for such conditions needed
  idKey: string15,
  latitudeKey: string15,
  longitudeKey: string15,
  sizeKey: string15,
  colorKey: string15,
  labelKey: string15,
  idName: string15,
  latitudeName: string15,
  longitudeName: string15,
  sizeName: string15,
  colorName: string15,
  labelName: string15,
  topology: object3,
  ...
  colorRange: arrayOf9(color9),
  title: string15,
  maxSize: positiveNumber15,
  sizeDomain: arrayOf9(positiveNumber15),
  label: {
    placement: union11("top", "bottom", "left", "right"),
...
import {
  arrayOf as arrayOf10,
  callback as callback15,
  color as color10,
  constant as constant17,
  fillOptionsDef as fillOptionsDef12,
  lineDashOptionsDef as lineDashOptionsDef14,
  object as object4,
  positiveNumber as positiveNumber16,
  required as required17,
  string as string16,
  strokeOptionsDef as strokeOptionsDef16
} from "ag-charts-core";
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs14, autoSizedLabelOptionsDefs: autoSizedLabelOptionsDefs3, tooltipOptionsDefs: tooltipOptionsDefs14 } = _ModuleSupport113;
var mapShapeSeriesOptionsDef = {
  type: required17(constant17("map-shape")),
  idKey: required17(string16),
  colorKey: string16,
  labelKey: string16,
  idName: string16,
  colorName: string16,
  labelName: string16,
  topology: object4,
  topologyIdKey: string16,
  legendItemName: string16,
  colorRange: arrayOf10(color10),
  padding: positiveNumber16,
  itemStyler: callback15,
  title: string16,
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundSeries.ts
var { createDatumId: createDatumId17, SeriesNodePickMode: SeriesNodePickMode13, Selection: Selection10, Group: Group12, PointerEvents: PointerEvents8, getShapeStyle: getShapeStyle12 } = _ModuleSupport116;
...
import {
  constant as constant18,
  fillOptionsDef as fillOptionsDef13,
  lineDashOptionsDef as lineDashOptionsDef15,
  object as object5,
  required as required18,
  strokeOptionsDef as strokeOptionsDef17
} from "ag-charts-core";
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs15 } = _ModuleSupport117;
var mapShapeBackgroundSeriesOptionsDef = {
  type: required18(constant18("map-shape-background")),
  topology: object5,
  ...commonSeriesOptionsDefs15,
  ...fillOptionsDef13,
  ...strokeOptionsDef17,
  ...lineDashOptionsDef15
};
...
import {
  ...
  callback as callback16,
  constant as constant19,
  fillOptionsDef as fillOptionsDef14,
  lineDashOptionsDef as lineDashOptionsDef16,
  number as number11,
  positiveNumber as positiveNumber17,
  required as required19,
  string as string17,
  strokeOptionsDef as strokeOptionsDef18
} from "ag-charts-core";
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs16, seriesLabelOptionsDefs: seriesLabelOptionsDefs10, tooltipOptionsDefs: tooltipOptionsDefs15 } = _ModuleSupport124;
var nightingaleSeriesOptionsDef = {
  type: required19(constant19("nightingale")),
  ...
  stacked: boolean14,
  stackGroup: string17,
  normalizedTo: number11,
  cornerRadius: positiveNumber17,
  itemStyler: callback16,
  label: seriesLabelOptionsDefs10,
  tooltip: tooltipOptionsDefs15,
  ...commonSeriesOptionsDefs16,
  ...fillOptionsDef14,
  ...strokeOptionsDef18,
  ...lineDashOptionsDef16
};
...
import {
  arrayOf as arrayOf11,
  boolean as boolean15,
  callback as callback17,
  color as color11,
  colorUnion as colorUnion4,
  constant as constant20,
  fillOptionsDef as fillOptionsDef15,
  lineDashOptionsDef as lineDashOptionsDef17,
  positiveNumber as positiveNumber18,
  required as required20,
  string as string18,
  strokeOptionsDef as strokeOptionsDef19,
  union as union12
} from "ag-charts-core";
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs17, seriesLabelOptionsDefs: seriesLabelOptionsDefs11, shadowOptionsDefs: shadowOptionsDefs5, tooltipOptionsDefs: tooltipOptionsDefs16, without: without5 } = _ModuleSupport129;
var pyramidSeriesOptionsDef = {
  type: required20(constant20("pyramid")),
  stageKey: required20(string18),
  valueKey: required20(string18),
  direction: union12("horizontal", "vertical"),
  aspectRatio: positiveNumber18,
  spacing: positiveNumber18,
  reverse: boolean15,
  itemStyler: callback17,
  fills: arrayOf11(colorUnion4),
  strokes: arrayOf11(color11),
  label: seriesLabelOptionsDefs11,
  stageLabel: {
    spacing: positiveNumber18,
    placement: union12("before", "after"),
    ...seriesLabelOptionsDefs11
  },
  tooltip: tooltipOptionsDefs16,
  shadow: shadowOptionsDefs5,
  ...commonSeriesOptionsDefs17,
  ...without5(fillOptionsDef15, ["fill"]),
  ...without5(strokeOptionsDef19, ["stroke"]),
  ...lineDashOptionsDef17
};
...
import { isFiniteNumber as isFiniteNumber2, isNumberEqual as isNumberEqual8 } from "ag-charts-core";
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaSeries.ts
var { Group: Group15, Path: Path10, PointerEvents: PointerEvents11, Selection: Selection13, ChartAxisDirection: ChartAxisDirection16, applyShapeStyle: applyShapeStyle10, getShapeFill: getShapeFill4, getShapeStyle: getShapeStyle16 } = _ModuleSupport136;
...
import {
  ...
  fillOptionsDef as fillOptionsDef16,
  lineDashOptionsDef as lineDashOptionsDef18,
  required as required21,
  string as string19,
  strokeOptionsDef as strokeOptionsDef20
} from "ag-charts-core";
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs18, seriesLabelOptionsDefs: seriesLabelOptionsDefs12, markerOptionsDefs: markerOptionsDefs3, tooltipOptionsDefs: tooltipOptionsDefs17 } = _ModuleSupport137;
var radarAreaSeriesOptionsDef = {
  type: required21(constant21("radar-area")),
  angleKey: required21(string19),
  radiusKey: required21(string19),
  angleName: string19,
  radiusName: string19,
  connectMissingData: boolean16,
...
import {
  ...
  lineDashOptionsDef as lineDashOptionsDef19,
  required as required22,
  string as string20,
  strokeOptionsDef as strokeOptionsDef21
} from "ag-charts-core";
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs19, seriesLabelOptionsDefs: seriesLabelOptionsDefs13, markerOptionsDefs: markerOptionsDefs4, tooltipOptionsDefs: tooltipOptionsDefs18 } = _ModuleSupport139;
var radarLineSeriesOptionsDef = {
  type: required22(constant22("radar-line")),
  angleKey: required22(string20),
  radiusKey: required22(string20),
  angleName: string20,
  radiusName: string20,
  connectMissingData: boolean17,
  marker: markerOptionsDefs4,
  label: seriesLabelOptionsDefs13,
  tooltip: tooltipOptionsDefs18,
  ...commonSeriesOptionsDefs19,
  ...strokeOptionsDef21,
  ...lineDashOptionsDef19
};
...
import {
  ...
  callback as callback18,
  constant as constant23,
  fillOptionsDef as fillOptionsDef17,
  lineDashOptionsDef as lineDashOptionsDef20,
  number as number12,
  positiveNumber as positiveNumber19,
  required as required23,
  string as string21,
  strokeOptionsDef as strokeOptionsDef22
} from "ag-charts-core";
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs20, seriesLabelOptionsDefs: seriesLabelOptionsDefs14, tooltipOptionsDefs: tooltipOptionsDefs19 } = _ModuleSupport144;
var radialBarSeriesOptionsDef = {
  type: required23(constant23("radial-bar")),
  angleKey: required23(string21),
  radiusKey: required23(string21),
  angleName: string21,
  radiusName: string21,
  grouped: boolean18,
  stacked: boolean18,
  stackGroup: string21,
  normalizedTo: number12,
  cornerRadius: positiveNumber19,
  itemStyler: callback18,
  label: seriesLabelOptionsDefs14,
  tooltip: tooltipOptionsDefs19,
  ...commonSeriesOptionsDefs20,
  ...fillOptionsDef17,
  ...strokeOptionsDef22,
  ...lineDashOptionsDef20
};
...
var { TempValidate: TempValidate35, RATIO: RATIO25 } = _ModuleSupport147;
...
import {
  ...
  callback as callback19,
  constant as constant24,
  fillOptionsDef as fillOptionsDef18,
  lineDashOptionsDef as lineDashOptionsDef21,
  number as number13,
  positiveNumber as positiveNumber20,
  ratio as ratio8,
  required as required24,
  string as string22,
  strokeOptionsDef as strokeOptionsDef23
} from "ag-charts-core";
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs21, seriesLabelOptionsDefs: seriesLabelOptionsDefs15, tooltipOptionsDefs: tooltipOptionsDefs20 } = _ModuleSupport149;
var radialColumnSeriesOptionsDef = {
  type: required24(constant24("radial-column")),
  angleKey: required24(string22),
  radiusKey: required24(string22),
  angleName: string22,
  radiusName: string22,
  grouped: boolean19,
  stacked: boolean19,
  stackGroup: string22,
  normalizedTo: number13,
  cornerRadius: positiveNumber20,
  columnWidthRatio: ratio8,
  maxColumnWidthRatio: ratio8,
  itemStyler: callback19,
  label: seriesLabelOptionsDefs15,
  tooltip: tooltipOptionsDefs20,
  ...commonSeriesOptionsDefs21,
  ...fillOptionsDef18,
  ...strokeOptionsDef23,
  ...lineDashOptionsDef21
};
...
var RadialGaugeSeriesProperties = class extends SeriesProperties12 {
  ...
  isValid(warningPrefix) {
    ...
    if (outerRadius == null !== (innerRadius == null)) {
      Logger13.warnOnce("Either [innerRadius] and [outerRadius] must both be set, or neither can be set.");
      return false;
    }
    return true;
  }
...
var RadialGaugeSeries = class extends _ModuleSupport155.Series {
  constructor(moduleCtx) {
    ...
    this.tickSelection = Selection14.select(this.tickGroup, _ModuleSupport155.TransformableText);
    this.datumUnion = new DatumUnion();
...
import {
  and as and3,
  arrayOf as arrayOf12,
  arrayOfDefs as arrayOfDefs5,
  boolean as boolean20,
  callback as callback20,
  color as color12,
  constant as constant25,
  fillOptionsDef as fillOptionsDef19,
  fontOptionsDef as fontOptionsDef5,
  greaterThan as greaterThan2,
  lessThan as lessThan2,
  lineDashOptionsDef as lineDashOptionsDef22,
  number as number14,
  or as or4,
  positiveNumber as positiveNumber21,
  ratio as ratio9,
  required as required25,
  string as string23,
  strokeOptionsDef as strokeOptionsDef24,
  union as union13
} from "ag-charts-core";
var {
...
var radialGaugeTargetOptionsDef = {
  value: required25(number14),
  text: string23,
  shape: or4(
    union13("circle", "cross", "diamond", "heart", "plus", "pin", "square", "star", "triangle", "line"),
    callback20
  ),
  placement: union13("inside", "outside", "middle"),
  spacing: positiveNumber21,
  size: positiveNumber21,
  rotation: number14,
  label: {
  ...
  ...fillOptionsDef19,
  ...strokeOptionsDef24,
  ...lineDashOptionsDef22
};
var radialGaugeSeriesOptionsDef = {
  type: required25(constant25("radial-gauge")),
  value: required25(number14),
  outerRadius: positiveNumber21,
  innerRadius: positiveNumber21,
  outerRadiusRatio: ratio9,
  innerRadiusRatio: ratio9,
  startAngle: number14,
  endAngle: number14,
  spacing: positiveNumber21,
  cornerMode: union13("container", "item"),
  cornerRadius: positiveNumber21,
  scale: {
    min: and3(number14, lessThan2("max")),
    max: and3(number14, greaterThan2("min")),
    label: {
      enabled: boolean20,
      formatter: callback20,
      rotation: number14,
      spacing: positiveNumber21,
      minSpacing: positiveNumber21,
      avoidCollisions: boolean20,
      format: numberFormatValidator4,
      ...fontOptionsDef5
    },
    interval: {
      values: arrayOf12(number14),
      step: number14
    },
    ...fillsOptionsDef,
    ...fillOptionsDef19,
  ...
  targets: arrayOfDefs5(radialGaugeTargetOptionsDef, "target options array"),
  segmentation: {
    enabled: boolean20,
    spacing: positiveNumber21,
    interval: {
...
radialGaugeSeriesOptionsDef.defaultColorRange = arrayOf12(color12);
...
radialGaugeSeriesOptionsDef.scale.defaultFill = color12;

// packages/ag-charts-enterprise/src/series/radial-gauge/radialGaugeModule.ts
var { FONT_SIZE_RATIO } = _ModuleSupport157;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $interpolate: [{ $palette: "secondDivergingColors" }, 5] },
          _ModuleSupport157.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        defaultFill: { $path: ["./1", { $palette: "fill" }, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        stroke: { $path: ["./2", _ModuleSupport157.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        label: {
          fontWeight: { $ref: "fontWeight" },
          fontSize: { $ref: "fontSize" },
...
var { BBox: BBox16, Path: Path11, ScenePathChangeDetection: ScenePathChangeDetection6, splitBezier } = _ModuleSupport158;
...
import {
  arrayOf as arrayOf13,
  callback as callback21,
  color as color13,
  colorUnion as colorUnion5,
  constant as constant26,
  fillGradientDefaults as fillGradientDefaults2,
  fillOptionsDef as fillOptionsDef20,
  fillPatternDefaults as fillPatternDefaults2,
  lineDashOptionsDef as lineDashOptionsDef23,
  positiveNumber as positiveNumber22,
  required as required26,
  string as string24,
  strokeOptionsDef as strokeOptionsDef25,
  union as union14
} from "ag-charts-core";
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs23, seriesLabelOptionsDefs: seriesLabelOptionsDefs17, tooltipOptionsDefs: tooltipOptionsDefs22 } = _ModuleSupport161;
var sankeySeriesOptionsDef = {
  type: required26(constant26("sankey")),
  fromKey: required26(string24),
  toKey: required26(string24),
  sizeKey: string24,
  sizeName: string24,
  fills: arrayOf13(colorUnion5),
  strokes: arrayOf13(color13),
  label: {
    ...seriesLabelOptionsDefs17,
    spacing: positiveNumber22
  },
  link: {
    itemStyler: callback21,
    ...fillOptionsDef20,
    ...strokeOptionsDef25,
    ...lineDashOptionsDef23
  },
  node: {
    width: positiveNumber22,
    spacing: positiveNumber22,
    alignment: union14("left", "center", "right", "justify"),
    itemStyler: callback21,
    ...fillOptionsDef20,
    ...strokeOptionsDef25,
    ...lineDashOptionsDef23
...
sankeySeriesOptionsDef.fillGradientDefaults = fillGradientDefaults2;
sankeySeriesOptionsDef.fillPatternDefaults = fillPatternDefaults2;
sankeySeriesOptionsDef.defaultColorRange = arrayOf13(arrayOf13(color13));
sankeySeriesOptionsDef.defaultPatternFills = arrayOf13(color13);
...
var SankeyModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      defaultPatternFills: _ModuleSupport162.SAFE_FILLS_OPERATION,
      highlightStyle: {
        series: {
          dimOpacity: 0.2
        }
...
var SunburstNode = class extends _ModuleSupport164.HierarchyNode {
  constructor() {
    super(...arguments);
    this.label = void 0;
...
var SunburstSeries = class extends _ModuleSupport164.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  updateNodes() {
    ...
    const updateSector = (nodeDatum, sector, style, highlighted) => {
      ...
      const fillBBox = _ModuleSupport164.isGradientFill(fill) && fill.bounds !== "item" ? seriesFillBBox : void 0;
  ...
  getTooltipContent(datumIndex) {
    ...
    if (_ModuleSupport164.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
    return tooltip.formatTooltip(
      properties,
...
import {
  arrayOf as arrayOf14,
  callback as callback22,
  color as color14,
  colorUnion as colorUnion6,
  constant as constant27,
  fillOptionsDef as fillOptionsDef21,
  positiveNumber as positiveNumber23,
  required as required27,
  string as string25,
  strokeOptionsDef as strokeOptionsDef26
} from "ag-charts-core";
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs24, autoSizedLabelOptionsDefs: autoSizedLabelOptionsDefs5, tooltipOptionsDefs: tooltipOptionsDefs23, without: without6 } = _ModuleSupport165;
var sunburstSeriesOptionsDef = {
  type: required27(constant27("sunburst")),
  labelKey: string25,
  secondaryLabelKey: string25,
  childrenKey: string25,
  sizeKey: string25,
  colorKey: string25,
  sizeName: string25,
  colorName: string25,
  fills: arrayOf14(colorUnion6),
  strokes: arrayOf14(color14),
  colorRange: arrayOf14(color14),
  sectorSpacing: positiveNumber23,
  cornerRadius: positiveNumber23,
  padding: positiveNumber23,
  itemStyler: callback22,
  label: {
    spacing: positiveNumber23,
    ...autoSizedLabelOptionsDefs5
  },
  secondaryLabel: autoSizedLabelOptionsDefs5,
  tooltip: tooltipOptionsDefs23,
  ...commonSeriesOptionsDefs24,
  ...without6(fillOptionsDef21, ["fill"]),
  ...without6(strokeOptionsDef26, ["stroke"]),
  highlightStyle: {
    label: {
      color: color14
    },
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstModule.ts
var { FONT_SIZE_RATIO: FONT_SIZE_RATIO2 } = _ModuleSupport166;
var SunburstModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
      ...
      fillPatternDefaults: _ModuleSupport166.FILL_PATTERN_DEFAULTS,
      label: {
        fontFamily: { $ref: "fontFamily" },
...
import {
  _ModuleSupport as _ModuleSupport168
} from "ag-charts-community";
...
var TreemapNode = class extends _ModuleSupport168.HierarchyNode {
  constructor() {
    super(...arguments);
...
var DistantGroup = class extends _ModuleSupport168.Group {
  distanceSquared(x, y) {
    return this.getBBox().distanceSquared(x, y);
  }
};
var TreemapSeries = class extends _ModuleSupport168.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  getTooltipContent(datumIndex) {
    ...
    if (_ModuleSupport168.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
...
import {
  arrayOf as arrayOf15,
  boolean as boolean21,
  callback as callback23,
  color as color15,
  colorUnion as colorUnion7,
  constant as constant28,
  fillGradientDefaults as fillGradientDefaults3,
  fillOptionsDef as fillOptionsDef22,
  fillPatternDefaults as fillPatternDefaults3,
  positiveNumber as positiveNumber24,
  required as required28,
  string as string26,
  strokeOptionsDef as strokeOptionsDef27,
  union as union15
} from "ag-charts-core";
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs25, seriesLabelOptionsDefs: seriesLabelOptionsDefs18, tooltipOptionsDefs: tooltipOptionsDefs24 } = _ModuleSupport169;
var treemapSeriesOptionsDef = {
  type: required28(constant28("treemap")),
  labelKey: string26,
  secondaryLabelKey: string26,
  childrenKey: string26,
  sizeKey: string26,
  colorKey: string26,
  sizeName: string26,
  colorName: string26,
  fills: arrayOf15(colorUnion7),
  strokes: arrayOf15(color15),
  colorRange: arrayOf15(color15),
  itemStyler: callback23,
  group: {
    gap: positiveNumber24,
    padding: positiveNumber24,
    cornerRadius: positiveNumber24,
    textAlign: union15("left", "center", "right"),
    interactive: boolean21,
    label: {
      ...seriesLabelOptionsDefs18,
      spacing: positiveNumber24
    },
    ...fillOptionsDef22,
    ...strokeOptionsDef27
  },
  tile: {
    ...
    cornerRadius: positiveNumber24,
    textAlign: union15("left", "center", "right"),
    verticalAlign: union15("top", "middle", "bottom"),
    label: {
      ...seriesLabelOptionsDefs18,
      spacing: positiveNumber24,
      lineHeight: positiveNumber24,
      minimumFontSize: positiveNumber24,
      wrapping: union15("never", "always", "hyphenate", "on-space"),
      overflowStrategy: union15("ellipsis", "hide")
    },
    secondaryLabel: {
      ...seriesLabelOptionsDefs18,
      lineHeight: positiveNumber24,
...
treemapSeriesOptionsDef.fillGradientDefaults = fillGradientDefaults3;
treemapSeriesOptionsDef.fillPatternDefaults = fillPatternDefaults3;
treemapSeriesOptionsDef.undocumentedGroupFills = arrayOf15(color15);
treemapSeriesOptionsDef.undocumentedGroupStrokes = arrayOf15(color15);

// packages/ag-charts-enterprise/src/series/treemap/treemapModule.ts
var { FONT_SIZE_RATIO: FONT_SIZE_RATIO3 } = _ModuleSupport170;
var TreemapModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
      ...
      fillPatternDefaults: _ModuleSupport170.FILL_PATTERN_DEFAULTS,
...
// packages/ag-charts-enterprise/src/main-modules.ts
var ModuleRegistry = _ModuleSupport171.ModuleRegistry;
