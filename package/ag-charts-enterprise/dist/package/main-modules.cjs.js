...
var RadiusAxis = class extends import_ag_charts_community10._ModuleSupport.PolarAxis {
  ...
  updateGridLines() {
    ...
    const isFullCircle = (0, import_ag_charts_core7.isNumberEqual)(endAngle - startAngle, 2 * Math.PI);
...
// packages/ag-charts-enterprise/src/axes/radius-category/radiusCategoryAxis.ts
var { RATIO: RATIO3, ProxyPropertyOnWrite, TempValidate: TempValidate8, CategoryScale: CategoryScale2 } = import_ag_charts_community11._ModuleSupport;
...
var { AND: AND3, GREATER_THAN: GREATER_THAN2, LESS_THAN: LESS_THAN2, NUMBER_OR_NAN: NUMBER_OR_NAN2, TempValidate: TempValidate9, normalisedExtentWithMetadata: normalisedExtentWithMetadata2, LinearScale: LinearScale2 } = import_ag_charts_community12._ModuleSupport;
...
__decorateClass([
  TempValidate9(AND3(NUMBER_OR_NAN2, LESS_THAN2("max")), { optional: true })
], RadiusNumberAxis.prototype, "min", 2);
__decorateClass([
  TempValidate9(AND3(NUMBER_OR_NAN2, GREATER_THAN2("min")), { optional: true })
...
var ordinalTimeAxisOptionsDefs = {
  ...cartesianAxisOptionsDefs,
  type: (0, import_ag_charts_core8.required)((0, import_ag_charts_core8.constant)("ordinal-time")),
  paddingInner: import_ag_charts_core8.ratio,
  paddingOuter: import_ag_charts_core8.ratio,
  groupPaddingInner: import_ag_charts_core8.ratio,
  label: {
    ...cartesianAxisLabelOptionsDefs,
    format: import_ag_charts_core8.string
  },
  interval: continuousAxisOptions((0, import_ag_charts_core8.or)(import_ag_charts_core8.number, import_ag_charts_core8.date), true).interval,
  crosshair: cartesianAxisCrosshairOptions(true)
};
var angleNumberAxisOptionsDefs = {
  ...commonAxisOptionsDefs,
  ...continuousAxisOptions(import_ag_charts_core8.number),
  type: (0, import_ag_charts_core8.required)((0, import_ag_charts_core8.constant)("angle-number")),
  crossLines: (0, import_ag_charts_core8.arrayOfDefs)(commonCrossLineOptionsDefs),
  startAngle: import_ag_charts_core8.number,
  endAngle: import_ag_charts_core8.number,
  label: {
    ...commonAxisLabelOptionsDefs,
    orientation: (0, import_ag_charts_core8.union)("fixed", "parallel", "perpendicular"),
...
var angleCategoryAxisOptionsDefs = {
  ...
  type: (0, import_ag_charts_core8.required)((0, import_ag_charts_core8.constant)("angle-category")),
  shape: (0, import_ag_charts_core8.union)("polygon", "circle"),
  crossLines: (0, import_ag_charts_core8.arrayOfDefs)(commonCrossLineOptionsDefs),
  startAngle: import_ag_charts_core8.number,
  endAngle: import_ag_charts_core8.number,
  paddingInner: import_ag_charts_core8.ratio,
...
var radiusNumberAxisOptionsDefs = {
  ...commonAxisOptionsDefs,
  ...continuousAxisOptions(import_ag_charts_core8.number),
  type: (0, import_ag_charts_core8.required)((0, import_ag_charts_core8.constant)("radius-number")),
  shape: (0, import_ag_charts_core8.union)("polygon", "circle"),
  positionAngle: import_ag_charts_core8.number,
  innerRadiusRatio: import_ag_charts_core8.ratio,
  crossLines: (0, import_ag_charts_core8.arrayOfDefs)(
    {
      ...commonCrossLineOptionsDefs,
      label: {
        ...commonCrossLineLabelOptionsDefs,
...
var radiusCategoryAxisOptionsDefs = {
  ...commonAxisOptionsDefs,
  type: (0, import_ag_charts_core8.required)((0, import_ag_charts_core8.constant)("radius-category")),
  positionAngle: import_ag_charts_core8.number,
  innerRadiusRatio: import_ag_charts_core8.ratio,
  paddingInner: import_ag_charts_core8.ratio,
  paddingOuter: import_ag_charts_core8.ratio,
...
var { Chart, TempValidate: TempValidate10, ARRAY: ARRAY2 } = import_ag_charts_community14._ModuleSupport;
...
__decorateClass([
  TempValidate10(ARRAY2, { optional: true })
...
function isValidCoordinate(v) {
  return Array.isArray(v) && v.length >= 2 && v.every(import_ag_charts_core9.isFiniteNumber);
}
...
var GEOJSON_OBJECT = import_ag_charts_community22._ModuleSupport.predicateWithMessage(isValidFeatureCollection, "a GeoJSON object");

// packages/ag-charts-enterprise/src/charts/topologyChart.ts
var { Chart: Chart5, MercatorScale, NumberAxis, TempValidate: TempValidate11 } = import_ag_charts_community23._ModuleSupport;
...
__decorateClass([
  TempValidate11(GEOJSON_OBJECT, { optional: true })
], TopologyChart.prototype, "topology", 2);

// packages/ag-charts-enterprise/src/charts/topologyChartModule.ts
var { isAgTopologyChartOptions, topologyChartOptionsDefs } = import_ag_charts_community24._ModuleSupport;
...
var { toolbarButtonOptionsDefs } = import_ag_charts_community25._ModuleSupport;
var annotationOptionsDef = {
  enabled: import_ag_charts_core10.boolean,
  axesButtons: {
    enabled: import_ag_charts_core10.boolean,
    axes: (0, import_ag_charts_core10.union)("x", "y", "xy")
  },
  toolbar: {
    enabled: import_ag_charts_core10.boolean,
    padding: import_ag_charts_core10.positiveNumber,
    buttons: (0, import_ag_charts_core10.arrayOfDefs)(
      {
        ...toolbarButtonOptionsDefs,
        value: (0, import_ag_charts_core10.union)(
          "line-menu",
          "fibonacci-menu",
          "text-menu",
          "shape-menu",
  ...
  optionsToolbar: {
    enabled: import_ag_charts_core10.boolean,
    buttons: (0, import_ag_charts_core10.arrayOf)(
      (0, import_ag_charts_core10.or)(
        ...
        (0, import_ag_charts_core10.optionsDefs)({
          ...toolbarButtonOptionsDefs,
          value: (0, import_ag_charts_core10.union)("lock"),
...
annotationOptionsDef.data = import_ag_charts_core10.array;
annotationOptionsDef.xKey = import_ag_charts_core10.string;
annotationOptionsDef.volumeKey = import_ag_charts_core10.string;
annotationOptionsDef.snap = import_ag_charts_core10.boolean;
...
var annotationValue = (0, import_ag_charts_core10.or)(
  ...
  (0, import_ag_charts_core10.optionsDefs)({
    value: xValue,
    groupPercentage: import_ag_charts_core10.number
  })
);
var annotationAxisLabelOptionsDef = {
  enabled: import_ag_charts_core10.boolean,
  cornerRadius: import_ag_charts_core10.positiveNumber,
  formatter: import_ag_charts_core10.callback,
  ...import_ag_charts_core10.fontOptionsDef,
  ...import_ag_charts_core10.fillOptionsDef,
  ...import_ag_charts_core10.strokeOptionsDef,
  ...import_ag_charts_core10.lineDashOptionsDef
};
var lineAnnotationTextOptionsDef = {
  label: import_ag_charts_core10.string,
  position: (0, import_ag_charts_core10.union)("top", "center", "bottom"),
  alignment: (0, import_ag_charts_core10.union)("left", "center", "right"),
  ...import_ag_charts_core10.fontOptionsDef
};
var channelAnnotationTextOptionsDef = {
  label: import_ag_charts_core10.string,
  position: (0, import_ag_charts_core10.union)("top", "inside", "bottom"),
  alignment: (0, import_ag_charts_core10.union)("left", "center", "right"),
  ...import_ag_charts_core10.fontOptionsDef
};
var annotationHandleOptionsDef = {
  ...import_ag_charts_core10.fillOptionsDef,
  ...import_ag_charts_core10.strokeOptionsDef,
  ...import_ag_charts_core10.lineDashOptionsDef
};
...
var annotationLineOptionsDef = {
  lineStyle: (0, import_ag_charts_core10.union)("solid", "dashed", "dotted"),
  ...import_ag_charts_core10.lineDashOptionsDef
};
var fibonacciAnnotationStylesOptionsDef = {
  visible: import_ag_charts_core10.boolean,
  extendStart: import_ag_charts_core10.boolean,
  extendEnd: import_ag_charts_core10.boolean,
  locked: import_ag_charts_core10.boolean,
  text: lineAnnotationTextOptionsDef,
  handle: annotationHandleOptionsDef,
  label: import_ag_charts_core10.fontOptionsDef,
  showFill: import_ag_charts_core10.boolean,
  isMultiColor: import_ag_charts_core10.boolean,
  strokes: (0, import_ag_charts_core10.arrayOf)(import_ag_charts_core10.color),
  rangeStroke: import_ag_charts_core10.color,
  bands: (0, import_ag_charts_core10.union)(4, 6, 10),
  ...import_ag_charts_core10.strokeOptionsDef,
...
var annotationInitialStateOptionsDef = (0, import_ag_charts_core10.typeUnion)({
  ...
  "disjoint-channel": {
    ...
    background: import_ag_charts_core10.fillOptionsDef,
    ...import_ag_charts_core10.strokeOptionsDef,
    ...annotationLineOptionsDef
  },
  "parallel-channel": {
  ...
  "date-range": {
    ...
    statistics: {
      divider: import_ag_charts_core10.strokeOptionsDef,
      ...import_ag_charts_core10.fontOptionsDef,
      ...import_ag_charts_core10.fillOptionsDef,
      ...import_ag_charts_core10.strokeOptionsDef
    },
...
var initialStateOptionsDef = {
  ...
  annotations: (0, import_ag_charts_core10.arrayOf)(annotationInitialStateOptionsDef),
...
var { ScalableGroup, Rect, Line: Line2, BBox: BBox2, Selection: Selection2, applyShapeFillBBox } = import_ag_charts_community26._ModuleSupport;
var BoxPlotGroup = class extends ScalableGroup {
  ...
  updateDatumStyles(datum, activeStyles, isVertical, isReversedValueAxis, fillBBox) {
    ...
    const selection = Selection2.select(this, Rect);
  ...
  distanceSquared(x, y) {
    const nodes = Selection2.selectByClass(this, Rect, Line2);
    return import_ag_charts_community26._ModuleSupport.nearestSquared(x, y, nodes).distanceSquared;
  }
  get midPoint() {
...
__decorateClass([
  TempValidate12(STRING2, { optional: true })
...
__decorateClass([
  TempValidate12(OR2(COLOR_GRADIENT, COLOR_PATTERN, COLOR_STRING2))
], BoxPlotSeriesProperties.prototype, "fill", 2);
__decorateClass([
  TempValidate12(OBJECT4)
...
__decorateClass([
  TempValidate12(FUNCTION, { optional: true })
...
var {
  ...
  isGradientFill,
  getShapeStyle
} = import_ag_charts_community28._ModuleSupport;
var BoxPlotSeriesNodeEvent = class extends import_ag_charts_community28._ModuleSupport.SeriesNodeEvent {
...
var BoxPlotSeries = class extends import_ag_charts_community28._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  getSeriesDomain(direction) {
    ...
    const yExtent = this.domainForClippedRange(ChartAxisDirection6.Y, ["minValue", "maxValue"], "xValue", true);
  ...
  getItemBaseStyle(highlighted) {
    ...
    const { cornerRadius, cap, whisker, fillGradientDefaults: fillGradientDefaults4, fillPatternDefaults: fillPatternDefaults4 } = properties;
  ...
  getItemStyleOverrides(datumId, datum, format, highlighted) {
    ...
    const { xKey, minKey, q1Key, medianKey, q3Key, maxKey, fillGradientDefaults: fillGradientDefaults4, fillPatternDefaults: fillPatternDefaults4, itemStyler } = properties;
    if (itemStyler == null)
      return;
    ...
    return getShapeStyle(overrides, fillGradientDefaults4, fillPatternDefaults4);
  }
  updateDatumNodes({
    datumSelection,
  ...
  getFormattedStyles(nodeDatum, scope) {
    ...
    if (itemStyler) {
      ...
      if (formatStyles) {
        styles = getShapeStyle(mergeDefaults2(formatStyles, styles), fillGradientDefaults4, fillPatternDefaults4);
      }
    }
    return styles;
  }
...
var { commonSeriesOptionsDefs, tooltipOptionsDefs } = import_ag_charts_community29._ModuleSupport;
var boxPlotSeriesOptionsDef = {
  type: (0, import_ag_charts_core12.required)((0, import_ag_charts_core12.constant)("box-plot")),
  xKey: (0, import_ag_charts_core12.required)(import_ag_charts_core12.string),
  minKey: (0, import_ag_charts_core12.required)(import_ag_charts_core12.string),
  q1Key: (0, import_ag_charts_core12.required)(import_ag_charts_core12.string),
  medianKey: (0, import_ag_charts_core12.required)(import_ag_charts_core12.string),
  q3Key: (0, import_ag_charts_core12.required)(import_ag_charts_core12.string),
  maxKey: (0, import_ag_charts_core12.required)(import_ag_charts_core12.string),
  xName: import_ag_charts_core12.string,
  yName: import_ag_charts_core12.string,
  minName: import_ag_charts_core12.string,
  q1Name: import_ag_charts_core12.string,
  medianName: import_ag_charts_core12.string,
  q3Name: import_ag_charts_core12.string,
  maxName: import_ag_charts_core12.string,
  direction: (0, import_ag_charts_core12.union)("horizontal", "vertical"),
  grouped: import_ag_charts_core12.boolean,
  legendItemName: import_ag_charts_core12.string,
  showInMiniChart: import_ag_charts_core12.boolean,
  cornerRadius: import_ag_charts_core12.positiveNumber,
  itemStyler: import_ag_charts_core12.callback,
  whisker: {
    ...import_ag_charts_core12.strokeOptionsDef,
    ...import_ag_charts_core12.lineDashOptionsDef
  },
  cap: {
    lengthRatio: import_ag_charts_core12.ratio
  },
  tooltip: tooltipOptionsDefs,
  ...commonSeriesOptionsDefs,
  ...import_ag_charts_core12.fillOptionsDef,
  ...import_ag_charts_core12.strokeOptionsDef,
  ...import_ag_charts_core12.lineDashOptionsDef
};
...
var { CARTESIAN_AXIS_TYPE } = import_ag_charts_community30._ModuleSupport.ThemeConstants;
  ...
  series: {
    ...
    fill: {
      $if: [
        ...
        { $palette: "fill" },
        { $mix: [import_ag_charts_community30._ModuleSupport.SAFE_FILL_OPERATION, { $ref: "backgroundColor" }, 0.7] }
      ]
    },
    ...
    fillPatternDefaults: import_ag_charts_community30._ModuleSupport.FILL_PATTERN_DEFAULTS,
    strokeWidth: 2
  },
  axes: {
...
var BoxPlotModule = {
  ...
  defaultAxes: import_ag_charts_community31._ModuleSupport.DIRECTION_SWAP_AXES,
...
var { findMinMax: findMinMax2 } = import_ag_charts_community32._ModuleSupport;
var X_MIN = 0;
var X_MAX = 1;
var Y_MIN = 2;
var Y_MAX = 3;
...
var OhlcSeriesNodeEvent = class extends import_ag_charts_community33._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var OhlcSeriesBase = class extends import_ag_charts_community33._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  aggregateData(dataModel, processedData) {
    ...
    if (xAxis == null || !(ContinuousScale3.is(xAxis.scale) || OrdinalTimeScale2.is(xAxis.scale)))
      return;
    const xValues = dataModel.resolveKeysById(this, `xValue`, processedData);
  ...
  getSeriesDomain(direction) {
    ...
    const yExtent = this.domainForClippedRange(ChartAxisDirection7.Y, ["highValue", "lowValue"], "xValue", true);
  ...
  createNodeData() {
    ...
    if (dataAggregationFilter == null) {
      ...
      for (let datumIndex = start; datumIndex < end; datumIndex += 1) {
        ...
        if (!validLowValue) {
          import_ag_charts_core13.Logger.warnOnce(
  ...
  getItemBaseStyle(itemId, highlighted) {
    ...
    return item.fillGradientDefaults && item.fillPatternDefaults ? getShapeStyle2(shapeStyle, item.fillGradientDefaults, item.fillPatternDefaults) : shapeStyle;
  }
  getItemStyleOverrides(datumId, datum, itemId, format, highlighted) {
    ...
    return item.fillGradientDefaults && item.fillPatternDefaults ? getShapeStyle2(overrides, item.fillGradientDefaults, item.fillPatternDefaults) : overrides;
  }
  getTooltipContent(datumIndex) {
    const { id: seriesId, dataModel, processedData, properties } = this;
    const {
    ...
    if (item.fillGradientDefaults && item.fillPatternDefaults) {
      marker = getShapeStyle2(marker, item.fillGradientDefaults, item.fillPatternDefaults);
    }
    return tooltip.formatTooltip(
      this.properties,
      {
...
var { Path: Path5, ScenePathChangeDetection, BBox: BBox3 } = import_ag_charts_community34._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickNode.ts
var { ScenePathChangeDetection: ScenePathChangeDetection2, ExtendedPath2D, BBox: BBox4 } = import_ag_charts_community35._ModuleSupport;
...
__decorateClass([
  TempValidate13(STRING3, { optional: true })
...
__decorateClass([
  TempValidate13(FUNCTION2, { optional: true })
...
__decorateClass([
  TempValidate14(OR3(COLOR_GRADIENT2, COLOR_PATTERN2, COLOR_STRING4))
], CandlestickSeriesItem.prototype, "fill", 2);
__decorateClass([
  TempValidate14(OBJECT6)
...
__decorateClass([
  TempValidate14(FUNCTION3, { optional: true })
], CandlestickSeriesProperties.prototype, "itemStyler", 2);

// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeries.ts
var { createDatumId: createDatumId3, isGradientFill: isGradientFill2, isPatternFill, applyShapeFillBBox: applyShapeFillBBox2, getShapeFill, getShapeStyle: getShapeStyle3 } = import_ag_charts_community38._ModuleSupport;
var CandlestickSeries = class extends OhlcSeriesBase {
  ...
  updateDatumNodes({
    ...
    datumSelection.each((node, datum) => {
      ...
      let style;
      if (itemStyler != null) {
        const { fill: fill2, fillOpacity, stroke, strokeWidth, strokeOpacity, lineDash, lineDashOffset } = isRising ? upStyle : downStyle;
      ...
      applyShapeFillBBox2(node, fill, this.getShapeFillBBox());
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs2, tooltipOptionsDefs: tooltipOptionsDefs2 } = import_ag_charts_community39._ModuleSupport;
var candlestickSeriesItemOptionsDef = {
  cornerRadius: import_ag_charts_core14.positiveNumber,
  wick: {
    ...import_ag_charts_core14.strokeOptionsDef,
    ...import_ag_charts_core14.lineDashOptionsDef
  },
  ...import_ag_charts_core14.fillOptionsDef,
  ...import_ag_charts_core14.strokeOptionsDef,
  ...import_ag_charts_core14.lineDashOptionsDef
};
var candlestickSeriesOptionsDef = {
  type: (0, import_ag_charts_core14.required)((0, import_ag_charts_core14.constant)("candlestick")),
  xKey: (0, import_ag_charts_core14.required)(import_ag_charts_core14.string),
  ...
  openName: import_ag_charts_core14.string,
  highName: import_ag_charts_core14.string,
  lowName: import_ag_charts_core14.string,
  closeName: import_ag_charts_core14.string,
  item: {
    up: candlestickSeriesItemOptionsDef,
    down: candlestickSeriesItemOptionsDef
  },
  itemStyler: import_ag_charts_core14.callback,
  showInMiniChart: import_ag_charts_core14.boolean,
  tooltip: tooltipOptionsDefs2,
  ...commonSeriesOptionsDefs2
};
candlestickSeriesOptionsDef.pickOutsideVisibleMinorAxis = import_ag_charts_core14.boolean;
candlestickSeriesOptionsDef.focusPriority = import_ag_charts_core14.number;
...
var { CARTESIAN_AXIS_TYPE: CARTESIAN_AXIS_TYPE2 } = import_ag_charts_community40._ModuleSupport.ThemeConstants;
function itemTheme(key) {
  return {
    ...
    fillPatternDefaults: import_ag_charts_community40._ModuleSupport.FILL_PATTERN_DEFAULTS
  };
}
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickModule.ts
var { CARTESIAN_AXIS_TYPE: CARTESIAN_AXIS_TYPE3, CARTESIAN_POSITION } = import_ag_charts_community41._ModuleSupport.ThemeConstants;
...
var { CachedTextMeasurerPool, TextUtils: TextUtils2, TextWrapper: TextWrapper2 } = import_ag_charts_community42._ModuleSupport;
...
function formatStackedLabels(labelValue, labelProps, secondaryLabelValue, secondaryLabelProps, { padding }, sizeFittingHeight) {
  ...
  let label;
  let secondaryLabel;
  return (0, import_ag_charts_core15.findMaxValue)(0, fontSizeCandidates.length - 1, (index) => {
...
function formatSingleLabel(value, props, { padding }, sizeFittingHeight) {
  ...
  return (0, import_ag_charts_core15.findMaxValue)(minimumFontSize, props.fontSize, (fontSize) => {
...
function formatLabels(baseLabelValue, labelProps, baseSecondaryLabelValue, secondaryLabelProps, layoutParams, sizeFittingHeight) {
  ...
  if (hasInvalidFontSize(labelProps) || hasInvalidFontSize(secondaryLabelProps)) {
    import_ag_charts_core15.Logger.warnOnce(`minimumFontSize should be set to a value less than or equal to the font size`);
  }
  let value;
...
var { TempValidate: TempValidate15, NUMBER: NUMBER5, POSITIVE_NUMBER: POSITIVE_NUMBER6, TEXT_WRAP, OVERFLOW_STRATEGY } = import_ag_charts_community43._ModuleSupport;
var BaseAutoSizedLabel = class extends import_ag_charts_community43._ModuleSupport.Label {
  constructor() {
    super(...arguments);
...
__decorateClass([
  TempValidate15(TEXT_WRAP)
], BaseAutoSizedLabel.prototype, "wrapping", 2);
__decorateClass([
  TempValidate15(OVERFLOW_STRATEGY)
], BaseAutoSizedLabel.prototype, "overflowStrategy", 2);
__decorateClass([
  TempValidate15(POSITIVE_NUMBER6, { optional: true })
...
__decorateClass([
  TempValidate16(STRING4, { optional: true })
], HeatmapSeriesProperties.prototype, "title", 2);
__decorateClass([
  TempValidate16(STRING4)
...
var HeatmapSeriesNodeEvent = class extends import_ag_charts_community45._ModuleSupport.CartesianSeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var HeatmapSeries = class extends import_ag_charts_community45._ModuleSupport.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  async processData(dataController) {
    ...
    const { dataModel, processedData } = await this.requestDataModel(dataController, this.data, {
      props: [
        ...
        ...colorKey ? [valueProperty3(colorKey, colorScaleType, { id: "colorValue" })] : []
      ]
    });
  ...
  createNodeData() {
    ...
    rawData.forEach((datum, datumIndex) => {
      ...
      if (labels?.label != null) {
        ...
        const { fontStyle, fontFamily, fontWeight, color: color16 } = this.properties.label;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs3, autoSizedLabelOptionsDefs, tooltipOptionsDefs: tooltipOptionsDefs3 } = import_ag_charts_community46._ModuleSupport;
var heatmapSeriesOptionsDef = {
  type: (0, import_ag_charts_core17.required)((0, import_ag_charts_core17.constant)("heatmap")),
  xKey: (0, import_ag_charts_core17.required)(import_ag_charts_core17.string),
  yKey: (0, import_ag_charts_core17.required)(import_ag_charts_core17.string),
  colorKey: import_ag_charts_core17.string,
  xName: import_ag_charts_core17.string,
  yName: import_ag_charts_core17.string,
  colorName: import_ag_charts_core17.string,
  colorRange: (0, import_ag_charts_core17.arrayOf)(import_ag_charts_core17.color),
  title: import_ag_charts_core17.string,
  textAlign: (0, import_ag_charts_core17.union)("left", "center", "right"),
  verticalAlign: (0, import_ag_charts_core17.union)("top", "middle", "bottom"),
  itemPadding: import_ag_charts_core17.positiveNumber,
  itemStyler: import_ag_charts_core17.callback,
  showInMiniChart: import_ag_charts_core17.boolean,
  label: autoSizedLabelOptionsDefs,
  tooltip: tooltipOptionsDefs3,
  ...commonSeriesOptionsDefs3,
  ...import_ag_charts_core17.strokeOptionsDef
};
  ...
  series: {
    ...
    colorRange: {
      $if: [
        ...
        import_ag_charts_community47._ModuleSupport.SAFE_RANGE2_OPERATION
      ]
    },
    label: {
      enabled: false,
...
var { createDatumId: createDatumId5 } = import_ag_charts_community49._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs4, tooltipOptionsDefs: tooltipOptionsDefs4 } = import_ag_charts_community50._ModuleSupport;
var ohlcSeriesItemOptionsDef = {
  ...import_ag_charts_core18.strokeOptionsDef,
  ...import_ag_charts_core18.lineDashOptionsDef
};
var ohlcSeriesOptionsDef = {
  type: (0, import_ag_charts_core18.required)((0, import_ag_charts_core18.constant)("ohlc")),
  xKey: (0, import_ag_charts_core18.required)(import_ag_charts_core18.string),
  openKey: (0, import_ag_charts_core18.required)(import_ag_charts_core18.string),
  highKey: (0, import_ag_charts_core18.required)(import_ag_charts_core18.string),
  lowKey: (0, import_ag_charts_core18.required)(import_ag_charts_core18.string),
  closeKey: (0, import_ag_charts_core18.required)(import_ag_charts_core18.string),
  xName: import_ag_charts_core18.string,
  yName: import_ag_charts_core18.string,
  openName: import_ag_charts_core18.string,
  highName: import_ag_charts_core18.string,
  lowName: import_ag_charts_core18.string,
  closeName: import_ag_charts_core18.string,
  showInMiniChart: import_ag_charts_core18.boolean,
  itemStyler: import_ag_charts_core18.callback,
  item: {
...
ohlcSeriesOptionsDef.pickOutsideVisibleMinorAxis = import_ag_charts_core18.boolean;
ohlcSeriesOptionsDef.focusPriority = import_ag_charts_core18.number;

// packages/ag-charts-enterprise/src/series/ohlc/ohlcModule.ts
var { CARTESIAN_AXIS_TYPE: CARTESIAN_AXIS_TYPE5, CARTESIAN_POSITION: CARTESIAN_POSITION3 } = import_ag_charts_community51._ModuleSupport.ThemeConstants;
var OhlcModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var {
  ...
  COLOR_GRADIENT: COLOR_GRADIENT3,
  COLOR_PATTERN: COLOR_PATTERN3,
  OR: OR4,
  RATIO: RATIO8,
  STRING: STRING5,
  DropShadow,
...
__decorateClass([
  TempValidate17(PLACEMENT)
], RangeAreaSeriesLabel.prototype, "placement", 2);
__decorateClass([
  TempValidate17(POSITIVE_NUMBER8)
...
__decorateClass([
  TempValidate17(STRING5, { optional: true })
...
function prepareRangeAreaPathStrokeAnimationFns(status, highSpans, lowSpans, visibleToggleMode) {
  const removePhaseFn = (ratio10, path) => {
    plotInterpolatedLinePathStroke(ratio10, path, highSpans.removed);
    plotInterpolatedLinePathStroke(ratio10, path, lowSpans.removed);
  };
  const updatePhaseFn = (ratio10, path) => {
    plotInterpolatedLinePathStroke(ratio10, path, highSpans.moved);
    plotInterpolatedLinePathStroke(ratio10, path, lowSpans.moved);
  };
  const addPhaseFn = (ratio10, path) => {
    plotInterpolatedLinePathStroke(ratio10, path, highSpans.added);
    plotInterpolatedLinePathStroke(ratio10, path, lowSpans.added);
  };
...
var {
  ...
  applyShapeFillBBox: applyShapeFillBBox3,
...
var RangeAreaSeriesNodeEvent = class extends import_ag_charts_community54._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var RangeAreaSeries = class extends import_ag_charts_community54._ModuleSupport.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      hasMarkers: true,
      pathsPerSeries: ["fill", "stroke"],
      pickModes: [import_ag_charts_community54._ModuleSupport.SeriesNodePickMode.AXIS_ALIGNED],
      directionKeys: {
  ...
  updatePathNodes(opts) {
    ...
    const fillBBox = this.getShapeFillBBox();
    applyShapeFillBBox3(fill, seriesFill, fillBBox);
    fill.setProperties({
      stroke: void 0,
      lineJoin: "round",
      pointerEvents: PointerEvents2.None,
...
var {
  commonSeriesOptionsDefs: commonSeriesOptionsDefs5,
  interpolationValidator,
  markerOptionsDefs,
  seriesLabelOptionsDefs,
  shadowOptionsDefs,
  tooltipOptionsDefs: tooltipOptionsDefs5
} = import_ag_charts_community55._ModuleSupport;
var rangeAreaSeriesOptionsDef = {
  type: (0, import_ag_charts_core19.required)((0, import_ag_charts_core19.constant)("range-area")),
  xKey: (0, import_ag_charts_core19.required)(import_ag_charts_core19.string),
  yLowKey: (0, import_ag_charts_core19.required)(import_ag_charts_core19.string),
  yHighKey: (0, import_ag_charts_core19.required)(import_ag_charts_core19.string),
  xName: import_ag_charts_core19.string,
  yName: import_ag_charts_core19.string,
  yLowName: import_ag_charts_core19.string,
  yHighName: import_ag_charts_core19.string,
  showInMiniChart: import_ag_charts_core19.boolean,
  connectMissingData: import_ag_charts_core19.boolean,
  interpolation: interpolationValidator,
  label: {
    ...seriesLabelOptionsDefs,
    padding: import_ag_charts_core19.positiveNumber,
    placement: (0, import_ag_charts_core19.union)("inside", "outside")
  },
  marker: markerOptionsDefs,
  tooltip: tooltipOptionsDefs5,
  shadow: shadowOptionsDefs,
  ...commonSeriesOptionsDefs5,
  ...import_ag_charts_core19.fillOptionsDef,
  ...import_ag_charts_core19.strokeOptionsDef,
  ...import_ag_charts_core19.lineDashOptionsDef
};
rangeAreaSeriesOptionsDef.pickOutsideVisibleMinorAxis = import_ag_charts_core19.boolean;
rangeAreaSeriesOptionsDef.focusPriority = import_ag_charts_core19.number;
...
var RANGE_AREA_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: import_ag_charts_community56._ModuleSupport.FILL_PATTERN_DEFAULTS,
    stroke: { $palette: "stroke" },
    fillOpacity: 0.7,
  ...
  axes: {
    [import_ag_charts_community56._ModuleSupport.ThemeConstants.CARTESIAN_AXIS_TYPE.NUMBER]: {
...
var {
  ...
  STRING: STRING6,
  BOOLEAN: BOOLEAN4,
  COLOR_GRADIENT: COLOR_GRADIENT4,
  COLOR_PATTERN: COLOR_PATTERN4,
  OR: OR5,
...
__decorateClass([
  TempValidate18(PLACEMENT2)
], RangeBarSeriesLabel.prototype, "placement", 2);
__decorateClass([
  TempValidate18(POSITIVE_NUMBER9)
...
__decorateClass([
  TempValidate18(STRING6, { optional: true })
...
__decorateClass([
  TempValidate18(FUNCTION5, { optional: true })
...
var {
  ...
  OrdinalTimeScale: OrdinalTimeScale4,
  Rect: Rect3,
...
var RangeBarSeriesNodeEvent = class extends import_ag_charts_community59._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
    this.yLowKey = series.properties.yLowKey;
...
var RangeBarSeries = class extends import_ag_charts_community59._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  aggregateData(dataModel, processedData) {
    ...
    if (xAxis == null || !(ContinuousScale5.is(xAxis.scale) || OrdinalTimeScale4.is(xAxis.scale)))
      return;
    const xValues = dataModel.resolveKeysById(this, `xValue`, processedData);
    const yHighValues = dataModel.resolveColumnById(this, `yHighValue`, processedData);
    const yLowValues = dataModel.resolveColumnById(this, `yLowValue`, processedData);
  ...
  getItemBaseStyle(highlighted) {
    const { properties } = this;
    const { cornerRadius, fillGradientDefaults: fillGradientDefaults4, fillPatternDefaults: fillPatternDefaults4 } = properties;
    const highlightStyle = highlighted ? properties.highlightStyle.item : void 0;
  ...
  getItemStyleOverrides(datumId, datum, format, highlighted) {
    const { id: seriesId, properties } = this;
    const { xKey, yHighKey, yLowKey, itemStyler, fillGradientDefaults: fillGradientDefaults4, fillPatternDefaults: fillPatternDefaults4 } = properties;
    if (itemStyler == null)
      return;
    ...
    return getShapeStyle5(overrides, fillGradientDefaults4, fillPatternDefaults4);
  }
  updateDatumNodes(opts) {
    ...
    datumSelection.each((rect, datum) => {
      ...
      applyShapeStyle2(rect, style, overrides, fillBBox);
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs6, seriesLabelOptionsDefs: seriesLabelOptionsDefs2, shadowOptionsDefs: shadowOptionsDefs2, tooltipOptionsDefs: tooltipOptionsDefs6 } = import_ag_charts_community60._ModuleSupport;
var rangeBarSeriesOptionsDef = {
  type: (0, import_ag_charts_core20.required)((0, import_ag_charts_core20.constant)("range-bar")),
  ...
  direction: (0, import_ag_charts_core20.union)("horizontal", "vertical"),
  showInMiniChart: import_ag_charts_core20.boolean,
  cornerRadius: import_ag_charts_core20.positiveNumber,
  itemStyler: import_ag_charts_core20.callback,
  label: {
    ...seriesLabelOptionsDefs2,
    padding: import_ag_charts_core20.positiveNumber,
    placement: (0, import_ag_charts_core20.union)("inside", "outside")
  },
  tooltip: tooltipOptionsDefs6,
  shadow: shadowOptionsDefs2,
  ...commonSeriesOptionsDefs6,
  ...import_ag_charts_core20.fillOptionsDef,
  ...import_ag_charts_core20.strokeOptionsDef,
  ...import_ag_charts_core20.lineDashOptionsDef
};
rangeBarSeriesOptionsDef.pickOutsideVisibleMinorAxis = import_ag_charts_core20.boolean;
rangeBarSeriesOptionsDef.fastDataProcessing = import_ag_charts_core20.boolean;
rangeBarSeriesOptionsDef.focusPriority = import_ag_charts_core20.number;
...
var RANGE_BAR_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: import_ag_charts_community61._ModuleSupport.FILL_PATTERN_DEFAULTS,
    strokeWidth: 0,
    label: {
      enabled: false,
      fontSize: { $ref: "fontSize" },
  ...
  axes: {
    [import_ag_charts_community61._ModuleSupport.ThemeConstants.CARTESIAN_AXIS_TYPE.NUMBER]: {
      crosshair: { enabled: true }
    }
  }
};
...
var RangeBarModule = {
  ...
  tooltipDefaults: { range: "exact" },
  defaultAxes: import_ag_charts_community62._ModuleSupport.DIRECTION_SWAP_AXES,
...
var {
  ...
  TempValidate: TempValidate19,
  BOOLEAN: BOOLEAN5,
  COLOR_STRING: COLOR_STRING8,
  COLOR_PATTERN: COLOR_PATTERN5,
  FUNCTION: FUNCTION6,
  ...
  OR: OR6,
  COLOR_GRADIENT: COLOR_GRADIENT5,
  RATIO: RATIO10,
  STRING: STRING7,
  UNION: UNION3,
...
__decorateClass([
  TempValidate19(UNION3(["inside-center", "inside-start", "inside-end", "outside-start", "outside-end"], "a placement"))
], WaterfallSeriesLabel.prototype, "placement", 2);
__decorateClass([
  TempValidate19(POSITIVE_NUMBER10)
...
var WaterfallSeries = class extends import_ag_charts_community64._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  async processData(dataController) {
    ...
    if (!this.properties.isValid() || !this.visible)
      return;
    const positiveNumber25 = (v) => isContinuous(v) && Number(v) >= 0;
    ...
    const { processedData } = await this.requestDataModel(dataController, dataWithTotals, {
      props: [
        ...
        ...isContinuousX ? [import_ag_charts_community64._ModuleSupport.SMALLEST_KEY_INTERVAL, import_ag_charts_community64._ModuleSupport.LARGEST_KEY_INTERVAL] : [],
        ...extraProps
      ]
    });
    this.smallestDataInterval = processedData.reduced?.smallestKeyInterval;
  ...
  getItemStyle(datumId, datum, itemId, highlighted) {
    ...
    const highlightStyle = highlighted ? properties.highlightStyle.item : void 0;
    const { itemStyler, fillGradientDefaults: fillGradientDefaults4, fillPatternDefaults: fillPatternDefaults4 } = item;
    ...
    if (itemStyler != null) {
      ...
      itemStyle = getShapeStyle6(itemStyle, fillGradientDefaults4, fillPatternDefaults4);
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((rect, datum) => {
      ...
      applyShapeStyle3(rect, style, void 0, fillBBox);
      rect.visible = categoryAlongX ? datum.width > 0 : datum.height > 0;
      rect.crisp = datum.crisp;
    });
  }
  ...
  animateConnectorLinesHorizontal(opts) {
    ...
    this.ctx.animationManager.animate({
      ...
      from: startX,
      to: endX,
      ease: import_ag_charts_community64._ModuleSupport.Motion.easeOut,
      collapsable: false,
      onUpdate(pointX) {
        linePath.clear(true);
  ...
  updateLineNode(lineNode) {
    ...
    lineNode.setProperties({
      ...
      lineDashOffset,
      lineJoin: "round",
      pointerEvents: import_ag_charts_community64._ModuleSupport.PointerEvents.None
    });
  }
  isLabelEnabled() {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs7, seriesLabelOptionsDefs: seriesLabelOptionsDefs3, shadowOptionsDefs: shadowOptionsDefs3, tooltipOptionsDefs: tooltipOptionsDefs7 } = import_ag_charts_community65._ModuleSupport;
var waterfallSeriesItemOptionsDef = {
  name: import_ag_charts_core21.string,
  cornerRadius: import_ag_charts_core21.positiveNumber,
  itemStyler: import_ag_charts_core21.callback,
  label: {
    ...seriesLabelOptionsDefs3,
    padding: import_ag_charts_core21.positiveNumber,
    placement: (0, import_ag_charts_core21.union)("inside-start", "inside-center", "inside-end", "outside-start", "outside-end")
  },
  tooltip: tooltipOptionsDefs7,
  shadow: shadowOptionsDefs3,
  ...import_ag_charts_core21.fillOptionsDef,
  ...import_ag_charts_core21.strokeOptionsDef,
  ...import_ag_charts_core21.lineDashOptionsDef
};
var waterfallSeriesOptionsDef = {
  type: (0, import_ag_charts_core21.required)((0, import_ag_charts_core21.constant)("waterfall")),
  xKey: (0, import_ag_charts_core21.required)(import_ag_charts_core21.string),
  yKey: (0, import_ag_charts_core21.required)(import_ag_charts_core21.string),
  xName: import_ag_charts_core21.string,
  yName: import_ag_charts_core21.string,
  direction: (0, import_ag_charts_core21.union)("horizontal", "vertical"),
  totals: (0, import_ag_charts_core21.arrayOfDefs)(
    {
      totalType: (0, import_ag_charts_core21.required)((0, import_ag_charts_core21.union)("total", "subtotal")),
      index: (0, import_ag_charts_core21.required)(import_ag_charts_core21.positiveNumber),
      axisLabel: (0, import_ag_charts_core21.required)(import_ag_charts_core21.string)
    },
    "a total definition options array"
  ),
  showInMiniChart: import_ag_charts_core21.boolean,
  item: {
  ...
  line: {
    enabled: import_ag_charts_core21.boolean,
    ...import_ag_charts_core21.strokeOptionsDef,
    ...import_ag_charts_core21.lineDashOptionsDef
  },
  tooltip: tooltipOptionsDefs7,
...
function itemTheme2(key, index) {
  return {
    ...
    fillPatternDefaults: import_ag_charts_community66._ModuleSupport.FILL_PATTERN_DEFAULTS,
...
var WaterfallModule = {
  ...
  tooltipDefaults: { range: "exact" },
  defaultAxes: import_ag_charts_community67._ModuleSupport.DIRECTION_SWAP_AXES,
...
var navigatorHandleOptionsDef = {
  width: import_ag_charts_core22.positiveNumber,
  height: import_ag_charts_core22.positiveNumber,
  grip: import_ag_charts_core22.boolean,
  fill: import_ag_charts_core22.color,
  stroke: import_ag_charts_core22.color,
  strokeWidth: import_ag_charts_core22.positiveNumber,
  cornerRadius: import_ag_charts_core22.positiveNumber
};
...
var navigatorOptionsDef = {
  enabled: import_ag_charts_core22.boolean,
  height: import_ag_charts_core22.positiveNumber,
  spacing: import_ag_charts_core22.positiveNumber,
  cornerRadius: import_ag_charts_core22.number,
  mask: {
    fill: import_ag_charts_core22.color,
    fillOpacity: import_ag_charts_core22.ratio,
    stroke: import_ag_charts_core22.color,
    strokeWidth: import_ag_charts_core22.positiveNumber
  },
  ...
  miniChart: {
    enabled: import_ag_charts_core22.boolean,
    padding: {
      top: import_ag_charts_core22.positiveNumber,
      bottom: import_ag_charts_core22.positiveNumber
    },
    label: {
      enabled: import_ag_charts_core22.boolean,
      avoidCollisions: import_ag_charts_core22.boolean,
      spacing: import_ag_charts_core22.positiveNumber,
      format: numberFormatValidator2,
      formatter: import_ag_charts_core22.callback,
      interval: {
        minSpacing: import_ag_charts_core22.positiveNumber,
        maxSpacing: import_ag_charts_core22.positiveNumber,
        values: import_ag_charts_core22.array,
        step: import_ag_charts_core22.number
      },
      ...import_ag_charts_core22.fontOptionsDef
    },
    series: (0, import_ag_charts_core22.arrayOf)(
      (0, import_ag_charts_core22.typeUnion)({
...
function removeCircularLinks(links) {
  ...
  if (circularLinks.size !== 0) {
    import_ag_charts_core23.Logger.warnOnce("Some links formed circular references. These will be removed from the output.");
  }
...
// packages/ag-charts-enterprise/src/series/flow-proportion/flowProportionSeries.ts
var { Series, DataController, keyProperty: keyProperty6, valueProperty: valueProperty7, Selection: Selection3, Group: Group6, TransformableText } = import_ag_charts_community69._ModuleSupport;
...
var { BBox: BBox6, Path: Path6, ScenePathChangeDetection: ScenePathChangeDetection3 } = import_ag_charts_community70._ModuleSupport;
...
var ChordLink = class extends Path6 {
  ...
  computeBBox() {
    ...
    return new BBox6(centerX + x, centerY + y, width, height);
  }
...
var {
  ...
  STRING: STRING8,
  OR: OR7,
  COLOR_GRADIENT: COLOR_GRADIENT6,
  TempValidate: TempValidate20,
  COLOR_PATTERN: COLOR_PATTERN6,
  Label: Label4
...
__decorateClass([
  TempValidate20(POSITIVE_NUMBER11)
...
__decorateClass([
  TempValidate20(OR7(COLOR_GRADIENT6, COLOR_STRING9, COLOR_PATTERN6), { optional: true })
], ChordSeriesLinkProperties.prototype, "fill", 2);
__decorateClass([
  TempValidate20(RATIO11)
], ChordSeriesLinkProperties.prototype, "fillOpacity", 2);
__decorateClass([
  TempValidate20(COLOR_STRING9, { optional: true })
...
__decorateClass([
  TempValidate20(FUNCTION7, { optional: true })
...
__decorateClass([
  TempValidate20(STRING8, { optional: true })
...
var ChordSeries = class extends FlowProportionSeries {
  ...
  createNodeData() {
    ...
    if (nodeCount * spacingSweep >= 2 * Math.PI || radius <= 0) {
      import_ag_charts_core24.Logger.warnOnce("There was insufficient space to display the Chord Series.");
      return;
    }
  ...
  getNodeStyleOverrides(datumId, datum, datumIndex, size, label, format, highlighted) {
    ...
    return getShapeStyle7(overrides, this.properties.fillGradientDefaults, this.properties.fillPatternDefaults);
  }
  updateNodeNodes(opts) {
    ...
    datumSelection.each((sector, datum) => {
      ...
      applyShapeStyle4(sector, format, overrides, fillBBox);
  ...
  updateLinkNodes(opts) {
    ...
    datumSelection.each((link, datum) => {
      ...
      applyShapeStyle4(link, style, overrides, fillBBox);
  ...
  getShapeFillBBox() {
    ...
    const bbox = new BBox7(x, y, width, height);
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs8, seriesLabelOptionsDefs: seriesLabelOptionsDefs4, tooltipOptionsDefs: tooltipOptionsDefs8 } = import_ag_charts_community73._ModuleSupport;
var chordSeriesOptionsDef = {
  type: (0, import_ag_charts_core25.required)((0, import_ag_charts_core25.constant)("chord")),
  fromKey: (0, import_ag_charts_core25.required)(import_ag_charts_core25.string),
  toKey: (0, import_ag_charts_core25.required)(import_ag_charts_core25.string),
  sizeKey: import_ag_charts_core25.string,
  sizeName: import_ag_charts_core25.string,
  fills: (0, import_ag_charts_core25.arrayOf)(import_ag_charts_core25.colorUnion),
  strokes: (0, import_ag_charts_core25.arrayOf)(import_ag_charts_core25.color),
  label: {
    spacing: import_ag_charts_core25.positiveNumber,
    maxWidth: import_ag_charts_core25.positiveNumber,
    ...seriesLabelOptionsDefs4
  },
  link: {
    tension: import_ag_charts_core25.ratio,
    itemStyler: import_ag_charts_core25.callback,
    ...import_ag_charts_core25.fillOptionsDef,
    ...import_ag_charts_core25.strokeOptionsDef,
    ...import_ag_charts_core25.lineDashOptionsDef
  },
  node: {
    width: import_ag_charts_core25.positiveNumber,
    spacing: import_ag_charts_core25.positiveNumber,
    itemStyler: import_ag_charts_core25.callback,
    ...import_ag_charts_core25.fillOptionsDef,
    ...import_ag_charts_core25.strokeOptionsDef,
  ...
  tooltip: tooltipOptionsDefs8,
  ...commonSeriesOptionsDefs8
};
chordSeriesOptionsDef.fillGradientDefaults = import_ag_charts_core25.fillGradientDefaults;
chordSeriesOptionsDef.fillPatternDefaults = import_ag_charts_core25.fillPatternDefaults;
...
var { lineDistanceSquared, BBox: BBox8, Path: Path7, ScenePathChangeDetection: ScenePathChangeDetection4 } = import_ag_charts_community76._ModuleSupport;
var delta2 = 1e-6;
function pointsEq([ax, ay], [bx, by]) {
  return Math.abs(ax - bx) <= delta2 && Math.abs(ay - by) <= delta2;
}
...
var {
  ...
  applyShapeFillBBox: applyShapeFillBBox4,
...
var BaseFunnelSeries = class extends import_ag_charts_community78._ModuleSupport.AbstractBarSeries {
  ...
  getSeriesDomain(direction) {
    ...
    if (direction === this.getCategoryDirection()) {
      ...
      const yExtent = this.domainForClippedRange(ChartAxisDirection12.Y, ["yValue"], "xValue", true);
  ...
  updateConnectorNodes(opts) {
    const { fills, strokes, fillGradientDefaults: fillGradientDefaults4, fillPatternDefaults: fillPatternDefaults4 } = this.properties;
    ...
    opts.connectorSelection.each((connector, datum) => {
      ...
      applyShapeFillBBox4(connector, connectorFill, fillBBox);
...
var {
  ...
  AxisLabel,
  TempValidate: TempValidate21,
  UNION: UNION4,
  OR: OR8,
  ARRAY_OF: ARRAY_OF2,
  COLOR_GRADIENT: COLOR_GRADIENT7,
  COLOR_STRING: COLOR_STRING10,
  COLOR_STRING_ARRAY: COLOR_STRING_ARRAY4,
  COLOR_PATTERN: COLOR_PATTERN7,
...
// packages/ag-charts-enterprise/src/series/cone-funnel/coneFunnelSeries.ts
var { formatValue, Line: Line3 } = import_ag_charts_community80._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs9, seriesLabelOptionsDefs: seriesLabelOptionsDefs5, tooltipOptionsDefs: tooltipOptionsDefs9, without: without2 } = import_ag_charts_community81._ModuleSupport;
var coneFunnelSeriesOptionsDef = {
  type: (0, import_ag_charts_core26.required)((0, import_ag_charts_core26.constant)("cone-funnel")),
  stageKey: (0, import_ag_charts_core26.required)(import_ag_charts_core26.string),
  valueKey: (0, import_ag_charts_core26.required)(import_ag_charts_core26.string),
  direction: (0, import_ag_charts_core26.union)("horizontal", "vertical"),
  fills: (0, import_ag_charts_core26.arrayOf)(import_ag_charts_core26.colorUnion),
  strokes: (0, import_ag_charts_core26.arrayOf)(import_ag_charts_core26.color),
  showInMiniChart: import_ag_charts_core26.boolean,
  label: {
    spacing: import_ag_charts_core26.positiveNumber,
    placement: (0, import_ag_charts_core26.union)("before", "middle", "after"),
    ...seriesLabelOptionsDefs5
  },
  stageLabel: {
    rotation: import_ag_charts_core26.number,
    spacing: import_ag_charts_core26.positiveNumber,
    minSpacing: import_ag_charts_core26.positiveNumber,
    placement: (0, import_ag_charts_core26.union)("before", "after"),
    avoidCollisions: import_ag_charts_core26.boolean,
    itemStyler: import_ag_charts_core26.callback,
    format: import_ag_charts_core26.string,
    ...seriesLabelOptionsDefs5
  },
  tooltip: tooltipOptionsDefs9,
  ...commonSeriesOptionsDefs9,
  ...without2(import_ag_charts_core26.fillOptionsDef, ["fill"]),
  ...without2(import_ag_charts_core26.strokeOptionsDef, ["stroke"]),
  ...import_ag_charts_core26.lineDashOptionsDef
};
...
var {
  ...
  TempValidate: TempValidate22,
  UNION: UNION5,
  BOOLEAN: BOOLEAN6,
  ARRAY_OF: ARRAY_OF3,
  OR: OR9,
  COLOR_GRADIENT: COLOR_GRADIENT8,
  COLOR_STRING_ARRAY: COLOR_STRING_ARRAY5,
  COLOR_PATTERN: COLOR_PATTERN8,
...
__decorateClass([
  TempValidate22(UNION5(["before", "after"], "a placement"))
...
__decorateClass([
  TempValidate22(BOOLEAN6)
], FunnelDropOff.prototype, "enabled", 2);
__decorateClass([
  TempValidate22(OR9(COLOR_GRADIENT8, COLOR_STRING11, COLOR_PATTERN8), { optional: true })
], FunnelDropOff.prototype, "fill", 2);
__decorateClass([
  TempValidate22(RATIO13)
], FunnelDropOff.prototype, "fillOpacity", 2);
__decorateClass([
  TempValidate22(COLOR_STRING11, { optional: true })
], FunnelDropOff.prototype, "stroke", 2);
__decorateClass([
  TempValidate22(POSITIVE_NUMBER13)
], FunnelDropOff.prototype, "strokeWidth", 2);
__decorateClass([
  TempValidate22(RATIO13)
], FunnelDropOff.prototype, "strokeOpacity", 2);
__decorateClass([
  TempValidate22(LINE_DASH10)
...
__decorateClass([
  TempValidate22(STRING10)
], FunnelProperties.prototype, "stageKey", 2);
__decorateClass([
  TempValidate22(STRING10)
], FunnelProperties.prototype, "valueKey", 2);
__decorateClass([
  TempValidate22(ARRAY_OF3(OR9(COLOR_GRADIENT8, COLOR_PATTERN8, COLOR_STRING11)))
], FunnelProperties.prototype, "fills", 2);
__decorateClass([
  TempValidate22(OBJECT13)
...
__decorateClass([
  TempValidate22(COLOR_STRING_ARRAY5)
...
__decorateClass([
  TempValidate22(FUNCTION8, { optional: true })
...
var FunnelSeries = class extends BaseFunnelSeries {
  ...
  getItemStyleOverrides(datumId, datum, datumIndex, format, highlighted) {
    ...
    return getShapeStyle9(overrides, properties.fillGradientDefaults, properties.fillPatternDefaults);
  }
  updateDatumNodes(opts) {
    ...
    datumSelection.each((rect, datum) => {
      ...
      applyShapeStyle5(rect, style, overrides, fillBBox);
      rect.visible = categoryAlongX ? datum.width > 0 : datum.height > 0;
      rect.crisp = datum.crisp;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs10, seriesLabelOptionsDefs: seriesLabelOptionsDefs6, shadowOptionsDefs: shadowOptionsDefs4, tooltipOptionsDefs: tooltipOptionsDefs10, without: without3 } = import_ag_charts_community86._ModuleSupport;
var funnelSeriesOptionsDef = {
  type: (0, import_ag_charts_core27.required)((0, import_ag_charts_core27.constant)("funnel")),
  ...
  direction: (0, import_ag_charts_core27.union)("horizontal", "vertical"),
  fills: (0, import_ag_charts_core27.arrayOf)(import_ag_charts_core27.colorUnion),
  strokes: (0, import_ag_charts_core27.arrayOf)(import_ag_charts_core27.color),
  showInMiniChart: import_ag_charts_core27.boolean,
  itemStyler: import_ag_charts_core27.callback,
  spacingRatio: import_ag_charts_core27.ratio,
  crisp: import_ag_charts_core27.boolean,
  dropOff: {
    enabled: import_ag_charts_core27.boolean,
    ...import_ag_charts_core27.fillOptionsDef,
    ...import_ag_charts_core27.strokeOptionsDef,
    ...import_ag_charts_core27.lineDashOptionsDef
  },
  stageLabel: {
    rotation: import_ag_charts_core27.number,
    spacing: import_ag_charts_core27.positiveNumber,
    minSpacing: import_ag_charts_core27.positiveNumber,
    placement: (0, import_ag_charts_core27.union)("before", "after"),
    avoidCollisions: import_ag_charts_core27.boolean,
    itemStyler: import_ag_charts_core27.callback,
    format: import_ag_charts_core27.string,
    ...seriesLabelOptionsDefs6
  },
  label: seriesLabelOptionsDefs6,
  tooltip: tooltipOptionsDefs10,
  shadow: shadowOptionsDefs4,
  ...commonSeriesOptionsDefs10,
  ...without3(import_ag_charts_core27.fillOptionsDef, ["fill"]),
  ...without3(import_ag_charts_core27.strokeOptionsDef, ["stroke"]),
  ...import_ag_charts_core27.lineDashOptionsDef
};
...
function pickGaugeNearestDatum(self, point) {
  const it = (0, import_ag_charts_core28.iterate)(self.datumUnion.nodes(), self.targetSelection.nodes());
...
function pickGaugeFocus(self, opts) {
  ...
  const otherIndex = (0, import_ag_charts_core28.clamp)(0, opts.otherIndex + opts.otherIndexDelta, others.length - 1);
  if (others.length === 0)
    return;
  const { data, selection } = others[otherIndex];
  if (data == null || data.length === 0)
    return;
  const datumIndex = (0, import_ag_charts_core28.clamp)(0, opts.datumIndex, data.length - 1);
...
var { MARKER_SHAPE, UNION: UNION6, OR: OR10 } = import_ag_charts_community90._ModuleSupport;
var FILL_MODE = UNION6(["continuous", "discrete"], "a fill mode");
var TARGET_MARKER_SHAPE = OR10(MARKER_SHAPE, UNION6(["line"], "a marker shape"));
var CORNER_MODE = UNION6(["container", "item"], "a corner mode");
...
var { BaseProperties: BaseProperties8, TempValidate: TempValidate23, OBJECT: OBJECT14, BOOLEAN: BOOLEAN7, NUMBER: NUMBER7, NUMBER_ARRAY } = import_ag_charts_community91._ModuleSupport;
var GaugeSegmentationIntervalProperties = class extends BaseProperties8 {
  getSegments(scale, maxTicks) {
    ...
    if (ticks != null && ticks.length > maxTicks) {
      import_ag_charts_core29.Logger.warnOnce(
...
__decorateClass([
  TempValidate23(NUMBER_ARRAY, { optional: true })
], GaugeSegmentationIntervalProperties.prototype, "values", 2);
__decorateClass([
  TempValidate23(NUMBER7, { optional: true })
...
var {
  ...
  UNION: UNION7,
  AND: AND5,
  LESS_THAN: LESS_THAN3,
  GREATER_THAN: GREATER_THAN3,
  Label: Label7,
  AxisLabel: AxisLabel3
} = import_ag_charts_community92._ModuleSupport;
var TARGET_PLACEMENT = UNION7(["before", "after", "middle"], "a placement");
var LABEL_PLACEMENT = UNION7(
  [
    "inside-start",
    "outside-start",
    "inside-end",
...
var DIRECTION = UNION7(["horizontal", "vertical"], "an orientation");
var PLACEMENT3 = UNION7(["before", "after"], "a placement");
var LinearGaugeDefaultTargetLabelProperties = class extends Label7 {
};
__decorateClass([
  TempValidate24(NUMBER8, { optional: true })
...
__decorateClass([
  TempValidate24(NUMBER_ARRAY2, { optional: true })
...
__decorateClass([
  TempValidate24(PLACEMENT3, { optional: true })
...
__decorateClass([
  TempValidate24(AND5(NUMBER8, LESS_THAN3("max")))
], LinearGaugeScaleProperties.prototype, "min", 2);
__decorateClass([
  TempValidate24(AND5(NUMBER8, GREATER_THAN3("min")))
...
__decorateClass([
  TempValidate24(LABEL_PLACEMENT)
...
__decorateClass([
  TempValidate24(COLOR_STRING_ARRAY6)
...
__decorateClass([
  TempValidate24(FUNCTION9, { optional: true })
...
var { CachedTextMeasurerPool: CachedTextMeasurerPool3, BBox: BBox9 } = import_ag_charts_community93._ModuleSupport;
...
var LinearGaugeAxis = class {
  ...
  formatTick(value, index, domain, _fractionDigits, defaultFormatter) {
    const { label } = this;
    return label.formatter?.({ value, index, domain, boundSeries: void 0 }) ?? (label.format != null ? defaultFormatter?.(value) : void 0) ?? this.gauge.formatLabel(value);
  }
  inRange() {
    return true;
  }
...
var LinearGaugeSeries = class extends import_ag_charts_community94._ModuleSupport.Series {
  constructor(moduleCtx) {
    ...
    this.seriesRect = BBox10.NaN;
    this.gaugeRect = BBox10.NaN;
    this.scale = new LinearScale3();
    this.axis = new LinearGaugeAxis(this);
  ...
  getShapeFillBBox() {
    ...
    return new BBox10(originX, originY, horizontal ? length : thickness, horizontal ? thickness : length);
  }
  getTargets() {
    const { properties } = this;
  ...
  createNodeData() {
    ...
    this.gaugeRect = new BBox10(Math.min(x0, x1), Math.min(y0, y1), Math.abs(x1 - x0), Math.abs(y1 - y0));
    const originX = 0;
    const originY = 0;
    scale.domain = [scaleProps.min, scaleProps.max];
  ...
  update({ seriesRect }) {
    ...
    this.seriesRect = seriesRect ?? BBox10.NaN;
  ...
  updateDatumNodes(opts) {
    ...
    this.datumUnion.update(datumSelection, this.itemGroup, import_ag_charts_community94._ModuleSupport.Rect, (node, first, last) => {
      ...
      node.clipBBox ?? (node.clipBBox = new BBox10(NaN, NaN, NaN, NaN));
      node.x = first.x;
      node.y = first.y;
  ...
  formatLabelText(datum) {
    ...
    if (horizontal) {
      ...
      barRect = new BBox10(x, y, xValue2 - x, height);
    } else {
      const yValue = scale.convert(value);
      barRect = new BBox10(x, yValue, width, height - yValue);
    }
...
// packages/ag-charts-enterprise/src/series/linear-gauge/linearGaugeSeriesOptionsDef.ts
var import_ag_charts_community95 = require("ag-charts-community");
var import_ag_charts_core30 = require("ag-charts-core");
var {
  commonSeriesOptionsDefs: commonSeriesOptionsDefs11,
  autoSizedLabelOptionsDefs: autoSizedLabelOptionsDefs2,
  seriesLabelOptionsDefs: seriesLabelOptionsDefs7,
  tooltipOptionsDefs: tooltipOptionsDefs11,
  numberFormatValidator: numberFormatValidator3
} = import_ag_charts_community95._ModuleSupport;
var fillsOptionsDef = {
  fills: import_ag_charts_core30.gradientColorStops,
  fillMode: (0, import_ag_charts_core30.union)("continuous", "discrete")
};
var linearGaugeTargetOptionsDef = {
  value: (0, import_ag_charts_core30.required)(import_ag_charts_core30.number),
  text: import_ag_charts_core30.string,
  shape: (0, import_ag_charts_core30.or)(
    (0, import_ag_charts_core30.union)("circle", "cross", "diamond", "heart", "plus", "pin", "square", "star", "triangle", "line"),
    import_ag_charts_core30.callback
  ),
  placement: (0, import_ag_charts_core30.union)("before", "after", "middle"),
  spacing: import_ag_charts_core30.positiveNumber,
  size: import_ag_charts_core30.positiveNumber,
  rotation: import_ag_charts_core30.number,
  ...import_ag_charts_core30.fillOptionsDef,
  ...import_ag_charts_core30.strokeOptionsDef,
  ...import_ag_charts_core30.lineDashOptionsDef
};
var linearGaugeSeriesOptionsDef = {
  type: (0, import_ag_charts_core30.required)((0, import_ag_charts_core30.constant)("linear-gauge")),
  value: (0, import_ag_charts_core30.required)(import_ag_charts_core30.number),
  direction: (0, import_ag_charts_core30.union)("horizontal", "vertical"),
  cornerMode: (0, import_ag_charts_core30.union)("container", "item"),
  cornerRadius: import_ag_charts_core30.positiveNumber,
  thickness: import_ag_charts_core30.positiveNumber,
  scale: {
    min: (0, import_ag_charts_core30.and)(import_ag_charts_core30.number, (0, import_ag_charts_core30.lessThan)("max")),
    max: (0, import_ag_charts_core30.and)(import_ag_charts_core30.number, (0, import_ag_charts_core30.greaterThan)("min")),
    label: {
      enabled: import_ag_charts_core30.boolean,
      formatter: import_ag_charts_core30.callback,
      rotation: import_ag_charts_core30.number,
      spacing: import_ag_charts_core30.positiveNumber,
      minSpacing: import_ag_charts_core30.positiveNumber,
      placement: (0, import_ag_charts_core30.union)("before", "after"),
      avoidCollisions: import_ag_charts_core30.boolean,
      format: numberFormatValidator3,
      ...import_ag_charts_core30.fontOptionsDef
    },
    interval: {
      values: (0, import_ag_charts_core30.arrayOf)(import_ag_charts_core30.number),
      step: import_ag_charts_core30.number
    },
    ...fillsOptionsDef,
    ...import_ag_charts_core30.fillOptionsDef,
    ...import_ag_charts_core30.strokeOptionsDef,
  ...
  targets: (0, import_ag_charts_core30.arrayOfDefs)(linearGaugeTargetOptionsDef, "target options array"),
  segmentation: {
    enabled: import_ag_charts_core30.boolean,
    spacing: import_ag_charts_core30.positiveNumber,
    interval: {
      values: (0, import_ag_charts_core30.arrayOf)(import_ag_charts_core30.number),
      step: import_ag_charts_core30.number,
      count: import_ag_charts_core30.number
    }
  },
  bar: {
    enabled: import_ag_charts_core30.boolean,
    thickness: import_ag_charts_core30.positiveNumber,
    thicknessRatio: import_ag_charts_core30.ratio,
    ...fillsOptionsDef,
    ...import_ag_charts_core30.fillOptionsDef,
    ...import_ag_charts_core30.strokeOptionsDef,
    ...import_ag_charts_core30.lineDashOptionsDef
  ...
  label: {
    ...
    spacing: import_ag_charts_core30.positiveNumber,
    avoidCollisions: import_ag_charts_core30.boolean,
    placement: (0, import_ag_charts_core30.union)(
      "inside-start",
      "outside-start",
      "inside-end",
      "outside-end",
  ...
  tooltip: tooltipOptionsDefs11,
  ...commonSeriesOptionsDefs11
};
linearGaugeSeriesOptionsDef.margin = import_ag_charts_core30.number;
linearGaugeSeriesOptionsDef.defaultColorRange = (0, import_ag_charts_core30.arrayOf)(import_ag_charts_core30.color);
linearGaugeSeriesOptionsDef.defaultTarget = {
  ...linearGaugeTargetOptionsDef,
  value: import_ag_charts_core30.number,
  label: {
    ...seriesLabelOptionsDefs7,
    spacing: import_ag_charts_core30.number
  }
};
linearGaugeSeriesOptionsDef.defaultScale = linearGaugeSeriesOptionsDef.scale;
linearGaugeSeriesOptionsDef.scale.defaultFill = import_ag_charts_core30.color;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          ...
          import_ag_charts_community96._ModuleSupport.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        ...
        stroke: { $path: ["./2", import_ag_charts_community96._ModuleSupport.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        label: {
          spacing: 11
        }
...
function lineStringCenter(lineSegment) {
  ...
  for (let i = 1; i < lineSegment.length; i += 1) {
    ...
    if (nextDistance > targetDistance) {
      const ratio10 = (targetDistance - totalDistance) / segmentDistance;
      const point = [x0 + (x1 - x0) * ratio10, y0 + (y1 - y0) * ratio10];
...
var { LonLatBBox } = import_ag_charts_community97._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
var { Path: Path8, ExtendedPath2D: ExtendedPath2D2, BBox: BBox11, ScenePathChangeDetection: ScenePathChangeDetection5 } = import_ag_charts_community98._ModuleSupport;
...
var TopologySeriesProperties = class extends import_ag_charts_community99._ModuleSupport.SeriesProperties {
};
var TopologySeries = class extends import_ag_charts_community99._ModuleSupport.DataModelSeries {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs12, seriesLabelOptionsDefs: seriesLabelOptionsDefs8, tooltipOptionsDefs: tooltipOptionsDefs12 } = import_ag_charts_community102._ModuleSupport;
var mapLineSeriesOptionsDef = {
  ...
  topology: import_ag_charts_core32.object,
  topologyIdKey: import_ag_charts_core32.string,
  legendItemName: import_ag_charts_core32.string,
  maxStrokeWidth: import_ag_charts_core32.positiveNumber,
  title: import_ag_charts_core32.string,
  itemStyler: import_ag_charts_core32.callback,
  sizeDomain: (0, import_ag_charts_core32.arrayOf)(import_ag_charts_core32.positiveNumber),
  label: seriesLabelOptionsDefs8,
  tooltip: tooltipOptionsDefs12,
  ...commonSeriesOptionsDefs12,
  ...import_ag_charts_core32.strokeOptionsDef,
  ...import_ag_charts_core32.lineDashOptionsDef,
  highlightStyle: {
    ...commonSeriesOptionsDefs12.highlightStyle,
    ...import_ag_charts_core32.strokeOptionsDef
  }
};
mapLineSeriesOptionsDef.colorRange = (0, import_ag_charts_core32.and)((0, import_ag_charts_core32.arrayOf)(import_ag_charts_core32.color), (0, import_ag_charts_core32.arrayLength)(1));
...
var MapLineModule = {
  ...
  themeTemplate: {
    ...MAP_THEME_DEFAULTS,
    series: {
      stroke: import_ag_charts_community103._ModuleSupport.SAFE_STROKE_FILL_OPERATION,
      // @ts-expect-error undocumented option
      colorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $palette: "divergingColors" },
          import_ag_charts_community103._ModuleSupport.SAFE_RANGE2_OPERATION
        ]
      },
      strokeWidth: 1,
      maxStrokeWidth: 3,
...
var { COLOR_STRING: COLOR_STRING14, LINE_DASH: LINE_DASH13, OBJECT: OBJECT17, POSITIVE_NUMBER: POSITIVE_NUMBER16, RATIO: RATIO16, TempValidate: TempValidate26, SeriesProperties: SeriesProperties4, SeriesTooltip: SeriesTooltip13 } = import_ag_charts_community104._ModuleSupport;
...
var mapLineBackgroundSeriesOptionsDef = {
  ...
  topology: import_ag_charts_core34.object,
  ...import_ag_charts_core34.strokeOptionsDef,
  ...import_ag_charts_core34.lineDashOptionsDef
};
...
var { BBox: BBox12 } = import_ag_charts_community108._ModuleSupport;
function getTopologyShapeFillBBox(scale) {
  if (!scale)
    return;
  const { range: range2 } = scale;
  const width = range2[1][0] - range2[0][0];
  const height = range2[1][1] - range2[0][1];
  const bbox = new BBox12(0, 0, width, height);
  return {
    series: bbox,
    axis: bbox
  };
...
var {
  ...
  FUNCTION: FUNCTION11,
  NUMBER_ARRAY: NUMBER_ARRAY4,
  OBJECT: OBJECT18,
  OR: OR11,
  COLOR_GRADIENT: COLOR_GRADIENT9,
  COLOR_PATTERN: COLOR_PATTERN9,
  POSITIVE_NUMBER: POSITIVE_NUMBER17,
  RATIO: RATIO17,
  STRING: STRING13,
  MARKER_SHAPE: MARKER_SHAPE2,
  LINE_DASH: LINE_DASH14,
  TempValidate: TempValidate27,
...
__decorateClass([
  TempValidate27(GEOJSON_OBJECT, { optional: true })
], MapMarkerSeriesProperties.prototype, "topology", 2);
__decorateClass([
  TempValidate27(STRING13, { optional: true })
...
var MapMarkerSeries = class extends TopologySeries {
  constructor(moduleCtx) {
    ...
    this.highlightMarkerSelection = Selection8.select(this.highlightNode, Marker2);
  ...
  updatePlacedLabelData(labelData) {
    this.labelSelection = this.labelSelection.update(labelData, (text) => {
      text.pointerEvents = import_ag_charts_community110._ModuleSupport.PointerEvents.None;
    });
    this.updateLabelNodes({ labelSelection: this.labelSelection });
  }
  updateLabelNodes(opts) {
  ...
  updateMarkerNodes(opts) {
    ...
    markerSelection.each((marker, markerDatum) => {
      ...
      applyShapeStyle6(marker, style, overrides, fillBBox);
      marker.x = point.x;
      marker.y = point.y;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs13, markerOptionsDefs: markerOptionsDefs2, seriesLabelOptionsDefs: seriesLabelOptionsDefs9, tooltipOptionsDefs: tooltipOptionsDefs13, without: without4 } = import_ag_charts_community111._ModuleSupport;
var mapMarkerSeriesOptionsDef = {
  ...
  topology: import_ag_charts_core36.object,
  topologyIdKey: import_ag_charts_core36.string,
  legendItemName: import_ag_charts_core36.string,
  colorRange: (0, import_ag_charts_core36.arrayOf)(import_ag_charts_core36.color),
  title: import_ag_charts_core36.string,
  maxSize: import_ag_charts_core36.positiveNumber,
  sizeDomain: (0, import_ag_charts_core36.arrayOf)(import_ag_charts_core36.positiveNumber),
  label: {
    placement: (0, import_ag_charts_core36.union)("top", "bottom", "left", "right"),
    ...seriesLabelOptionsDefs9
  },
  tooltip: tooltipOptionsDefs13,
  ...commonSeriesOptionsDefs13,
  ...without4(markerOptionsDefs2, ["enabled"]),
  highlightStyle: {
    ...commonSeriesOptionsDefs13.highlightStyle,
    ...import_ag_charts_core36.fillOptionsDef,
    ...import_ag_charts_core36.strokeOptionsDef
  }
};
    ...
    series: {
      ...
      colorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $palette: "divergingColors" },
          import_ag_charts_community112._ModuleSupport.SAFE_RANGE2_OPERATION
        ]
      },
      // @ts-expect-error undocumented option
      fillGradientDefaults: {
      ...
      fillPatternDefaults: import_ag_charts_community112._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillOpacity: 0.5,
      label: {
        color: { $ref: "textColor" }
      }
...
var MapMarkerSeriesModule = {
  ...
  validate(options, optionsDefs2, path) {
    ...
    if (result.valid?.idKey == null && (result.valid?.latitudeKey == null || result.valid?.longitudeKey == null)) {
      ...
      result.errors.push(new import_ag_charts_core37.ValidationError(message, path, true));
    }
    return result;
  }
};
...
var {
  ...
  COLOR_GRADIENT: COLOR_GRADIENT10,
  COLOR_PATTERN: COLOR_PATTERN10,
  FUNCTION: FUNCTION12,
...
__decorateClass([
  TempValidate28(FUNCTION12, { optional: true })
...
var fixedScale = import_ag_charts_community114._ModuleSupport.MercatorScale.fixedScale();
var MapShapeSeries = class extends TopologySeries {
  ...
  getItemStyleOverrides(datumId, datum, colorValue, format, highlighted) {
    ...
    return getShapeStyle11(overrides, this.properties.fillGradientDefaults, this.properties.fillPatternDefaults);
  }
  updateDatumNodes(opts) {
    const { datumSelection, isHighlight } = opts;
    const style = this.getItemBaseStyle(isHighlight);
    ...
    datumSelection.each((geoGeometry, nodeDatum) => {
      ...
      geoGeometry.visible = true;
      geoGeometry.projectedGeometry = projectedGeometry;
      applyShapeStyle7(geoGeometry, style, overrides, fillBBox);
    });
  }
  updateLabelSelection(opts) {
    const labels = this.isLabelEnabled() ? opts.labelData : [];
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs14, autoSizedLabelOptionsDefs: autoSizedLabelOptionsDefs3, tooltipOptionsDefs: tooltipOptionsDefs14 } = import_ag_charts_community115._ModuleSupport;
var mapShapeSeriesOptionsDef = {
  ...
  topology: import_ag_charts_core39.object,
  topologyIdKey: import_ag_charts_core39.string,
  legendItemName: import_ag_charts_core39.string,
  colorRange: (0, import_ag_charts_core39.arrayOf)(import_ag_charts_core39.color),
  padding: import_ag_charts_core39.positiveNumber,
  itemStyler: import_ag_charts_core39.callback,
  title: import_ag_charts_core39.string,
  label: autoSizedLabelOptionsDefs3,
  tooltip: tooltipOptionsDefs14,
  ...commonSeriesOptionsDefs14,
  ...import_ag_charts_core39.fillOptionsDef,
  ...import_ag_charts_core39.strokeOptionsDef,
  ...import_ag_charts_core39.lineDashOptionsDef,
  highlightStyle: {
    ...commonSeriesOptionsDefs14.highlightStyle,
    ...import_ag_charts_core39.fillOptionsDef,
    ...import_ag_charts_core39.strokeOptionsDef
  }
};
    ...
    series: {
      ...
      colorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $palette: "divergingColors" },
          import_ag_charts_community116._ModuleSupport.SAFE_RANGE2_OPERATION
        ]
      },
      // @ts-expect-error undocumented option
      fillGradientDefaults: {
      ...
      fillPatternDefaults: import_ag_charts_community116._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillOpacity: 1,
      strokeWidth: 1,
      lineDash: [0],
      lineDashOffset: 0,
...
var {
  FillGradientDefaults: FillGradientDefaults11,
  FillPatternDefaults: FillPatternDefaults11,
  COLOR_STRING: COLOR_STRING17,
  COLOR_GRADIENT: COLOR_GRADIENT11,
  COLOR_PATTERN: COLOR_PATTERN11,
  OR: OR13,
  LINE_DASH: LINE_DASH16,
  OBJECT: OBJECT20,
  POSITIVE_NUMBER: POSITIVE_NUMBER19,
  RATIO: RATIO19,
  TempValidate: TempValidate29,
...
__decorateClass([
  TempValidate29(GEOJSON_OBJECT, { optional: true })
], MapShapeBackgroundSeriesProperties.prototype, "topology", 2);
__decorateClass([
  TempValidate29(OR13(COLOR_GRADIENT11, COLOR_PATTERN11, COLOR_STRING17))
], MapShapeBackgroundSeriesProperties.prototype, "fill", 2);
__decorateClass([
  TempValidate29(OBJECT20)
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundSeries.ts
var { createDatumId: createDatumId17, SeriesNodePickMode: SeriesNodePickMode13, Selection: Selection10, Group: Group12, PointerEvents: PointerEvents8, getShapeStyle: getShapeStyle12 } = import_ag_charts_community118._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs15 } = import_ag_charts_community119._ModuleSupport;
var mapShapeBackgroundSeriesOptionsDef = {
  ...
  topology: import_ag_charts_core41.object,
  ...commonSeriesOptionsDefs15,
  ...import_ag_charts_core41.fillOptionsDef,
  ...import_ag_charts_core41.strokeOptionsDef,
  ...import_ag_charts_core41.lineDashOptionsDef
};
...
var MapShapeBackgroundModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      fillPatternDefaults: {
        ...import_ag_charts_community120._ModuleSupport.FILL_PATTERN_DEFAULTS,
        fill: { $path: ["./1", { $palette: "fill" }, { $palette: "hierarchyColors" }] },
...
var RadialColumnSeriesNodeEvent = class extends import_ag_charts_community121._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends import_ag_charts_community121._ModuleSupport.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
  ...
  async processData(dataController) {
    ...
    const visibleProps = this.visible ? {} : { forceValue: 0 };
    const radiusScaleType = this.axes[ChartAxisDirection14.Y]?.scale.type;
    const angleScaleType = this.axes[ChartAxisDirection14.X]?.scale.type;
  ...
  isRadiusAxisReversed() {
    return this.axes[ChartAxisDirection14.Y]?.isReversed();
  }
  ...
  getItemStyleOverrides(datumId, datum, format, highlighted) {
    const { id: seriesId, properties } = this;
    const { angleKey, radiusKey, itemStyler, fillGradientDefaults: fillGradientDefaults4, fillPatternDefaults: fillPatternDefaults4 } = properties;
    if (itemStyler == null)
      return;
    ...
    return getShapeStyle13(overrides, fillGradientDefaults4, fillPatternDefaults4);
  }
  updateSectorSelection(selection, highlighted) {
    ...
    selection.update(selectionData, void 0, (datum) => this.getDatumId(datum)).each((node, nodeDatum) => {
      ...
      applyShapeStyle8(node, style, overrides, fillBBox, fillParams);
  ...
  getTooltipContent(datumIndex) {
    ...
    const radiusAxis = axes[ChartAxisDirection14.Y];
  ...
  legendItemSymbol() {
    ...
    if (import_ag_charts_community121._ModuleSupport.isGradientFill(markerStyle.fill)) {
...
var {
  ...
  Label: Label10,
  OR: OR14,
  COLOR_GRADIENT: COLOR_GRADIENT12,
  COLOR_PATTERN: COLOR_PATTERN12
...
__decorateClass([
  TempValidate30(STRING15)
], RadialColumnSeriesBaseProperties.prototype, "angleKey", 2);
__decorateClass([
  TempValidate30(STRING15, { optional: true })
...
__decorateClass([
  TempValidate30(OR14(COLOR_GRADIENT12, COLOR_PATTERN12, COLOR_STRING18))
], RadialColumnSeriesBaseProperties.prototype, "fill", 2);
__decorateClass([
  TempValidate30(OBJECT21)
...
var { motion: motion7 } = import_ag_charts_community123._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleUtil.ts
var { SectorBox, motion: motion8 } = import_ag_charts_community124._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleSeries.ts
var { Sector: Sector4, SectorBox: SectorBox2, PolarZIndexMap } = import_ag_charts_community125._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs16, seriesLabelOptionsDefs: seriesLabelOptionsDefs10, tooltipOptionsDefs: tooltipOptionsDefs15 } = import_ag_charts_community126._ModuleSupport;
var nightingaleSeriesOptionsDef = {
  ...
  cornerRadius: import_ag_charts_core43.positiveNumber,
  itemStyler: import_ag_charts_core43.callback,
  label: seriesLabelOptionsDefs10,
  tooltip: tooltipOptionsDefs15,
  ...commonSeriesOptionsDefs16,
  ...import_ag_charts_core43.fillOptionsDef,
  ...import_ag_charts_core43.strokeOptionsDef,
  ...import_ag_charts_core43.lineDashOptionsDef
};
...
var NIGHTINGALE_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: import_ag_charts_community127._ModuleSupport.FILL_PATTERN_DEFAULTS,
    strokeWidth: 1,
    label: {
      enabled: false,
      fontSize: { $ref: "fontSize" },
...
var {
  ...
  TempValidate: TempValidate31,
  UNION: UNION8,
  OR: OR15,
  ARRAY_OF: ARRAY_OF4,
  COLOR_GRADIENT: COLOR_GRADIENT13,
...
__decorateClass([
  TempValidate31(NUMBER10)
], PyramidSeriesStageLabel.prototype, "spacing", 2);
__decorateClass([
  TempValidate31(UNION8(["before", "after"], "a placement"))
...
var PyramidSeries = class extends import_ag_charts_community130._ModuleSupport.DataModelSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: void 0,
  ...
  getItemStyleOverrides(datumId, datum, datumIndex, format, highlighted) {
    ...
    return getShapeStyle14(overrides, this.properties.fillGradientDefaults, this.properties.fillPatternDefaults);
  }
  updateDatumNodes(opts) {
    const { datumSelection, isHighlight } = opts;
    const { properties } = this;
    ...
    datumSelection.each((connector, nodeDatum) => {
      ...
      applyShapeStyle9(connector, style, overrides, fillBBox);
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs17, seriesLabelOptionsDefs: seriesLabelOptionsDefs11, shadowOptionsDefs: shadowOptionsDefs5, tooltipOptionsDefs: tooltipOptionsDefs16, without: without5 } = import_ag_charts_community131._ModuleSupport;
var pyramidSeriesOptionsDef = {
  ...
  direction: (0, import_ag_charts_core44.union)("horizontal", "vertical"),
  aspectRatio: import_ag_charts_core44.positiveNumber,
  spacing: import_ag_charts_core44.positiveNumber,
  reverse: import_ag_charts_core44.boolean,
  itemStyler: import_ag_charts_core44.callback,
  fills: (0, import_ag_charts_core44.arrayOf)(import_ag_charts_core44.colorUnion),
  strokes: (0, import_ag_charts_core44.arrayOf)(import_ag_charts_core44.color),
  label: seriesLabelOptionsDefs11,
  stageLabel: {
    spacing: import_ag_charts_core44.positiveNumber,
    placement: (0, import_ag_charts_core44.union)("before", "after"),
    ...seriesLabelOptionsDefs11
  },
  tooltip: tooltipOptionsDefs16,
  shadow: shadowOptionsDefs5,
  ...commonSeriesOptionsDefs17,
  ...without5(import_ag_charts_core44.fillOptionsDef, ["fill"]),
  ...without5(import_ag_charts_core44.strokeOptionsDef, ["stroke"]),
  ...import_ag_charts_core44.lineDashOptionsDef
};
...
var PYRAMID_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: import_ag_charts_community132._ModuleSupport.FILL_PATTERN_DEFAULTS,
    label: {
      enabled: true,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
...
var BASE_RADAR_SERIES_THEME = {
  series: {
    ...
    marker: {
      ...
      fillPatternDefaults: import_ag_charts_community134._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillOpacity: 1,
      shape: "circle",
      size: 6,
      strokeOpacity: 1,
...
var RADAR_LINE_SERIES_THEME = import_ag_charts_community134._ModuleSupport.mergeDefaults(
  {
    series: {
      stroke: import_ag_charts_community134._ModuleSupport.SAFE_STROKE_FILL_OPERATION,
      strokeWidth: 2
    }
  },
  BASE_RADAR_SERIES_THEME
);
var RADAR_AREA_SERIES_THEME = import_ag_charts_community134._ModuleSupport.mergeDefaults(
  {
    series: {
      fill: { $palette: "fill" },
      fillGradientDefaults: {
...
} = import_ag_charts_community136._ModuleSupport;
var RadarSeriesNodeEvent = class extends import_ag_charts_community136._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends import_ag_charts_community136._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: "angleValue",
  ...
  createNodeData() {
    ...
    const angleScale = this.axes[ChartAxisDirection15.X]?.scale;
    const radiusScale = this.axes[ChartAxisDirection15.Y]?.scale;
    if (!angleScale || !radiusScale) {
      return;
    }
  ...
  getTooltipContent(datumIndex) {
    ...
    const angleAxis = axes[ChartAxisDirection15.X];
  ...
  animateSinglePath(pathNode, points, ratio10) {
    const { path } = pathNode;
    path.clear(true);
    const axisInnerRadius = this.getAxisInnerRadius();
    const radiusAxis = this.axes[ChartAxisDirection15.Y];
  ...
  animatePaths(ratio10) {
    const linePoints = this.getLinePoints();
    const lineNode = this.getLineNode();
    if (!lineNode)
      return;
    this.animateSinglePath(lineNode, linePoints, ratio10);
  }
  animateEmptyUpdateReady() {
    ...
    animationManager.animate({
      ...
      phase: "initial",
      collapsable: false,
      onUpdate: (ratio10) => this.animatePaths(ratio10),
...
var {
  ...
  TempValidate: TempValidate33,
  OR: OR16,
  COLOR_GRADIENT: COLOR_GRADIENT14,
  COLOR_PATTERN: COLOR_PATTERN14,
  OBJECT: OBJECT24
...
__decorateClass([
  TempValidate33(OR16(COLOR_GRADIENT14, COLOR_PATTERN14, COLOR_STRING21))
], RadarAreaSeriesProperties.prototype, "fill", 2);
__decorateClass([
  TempValidate33(OBJECT24)
], RadarAreaSeriesProperties.prototype, "fillGradientDefaults", 2);
__decorateClass([
  TempValidate33(OBJECT24)
], RadarAreaSeriesProperties.prototype, "fillPatternDefaults", 2);
__decorateClass([
  TempValidate33(RATIO23)
], RadarAreaSeriesProperties.prototype, "fillOpacity", 2);

// packages/ag-charts-enterprise/src/series/radar-area/radarAreaSeries.ts
var { Group: Group15, Path: Path10, PointerEvents: PointerEvents11, Selection: Selection13, ChartAxisDirection: ChartAxisDirection16, applyShapeStyle: applyShapeStyle10, getShapeFill: getShapeFill4, getShapeStyle: getShapeStyle16 } = import_ag_charts_community138._ModuleSupport;
var RadarAreaSeries = class extends RadarSeries {
  ...
  beforePathAnimation() {
    ...
    applyShapeStyle10(areaNode, style, void 0, this.getShapeFillBBox());
    areaNode.pointerEvents = PointerEvents11.None;
    areaNode.stroke = void 0;
  }
  animatePaths(ratio10) {
    super.animatePaths(ratio10);
    this.animateSinglePath(this.getAreaNode(), this.getAreaPoints(), ratio10);
  }
  getAreaPoints() {
    const points = this.getLinePoints();
    const getPolarAxis = (direction) => {
      const axis = this.axes[direction];
      return axis instanceof import_ag_charts_community138._ModuleSupport.PolarAxis ? axis : void 0;
    };
    const radiusAxis = getPolarAxis(ChartAxisDirection16.Y);
    const angleAxis = getPolarAxis(ChartAxisDirection16.X);
    const reversedRadiusAxis = radiusAxis?.isReversed();
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs18, seriesLabelOptionsDefs: seriesLabelOptionsDefs12, markerOptionsDefs: markerOptionsDefs3, tooltipOptionsDefs: tooltipOptionsDefs17 } = import_ag_charts_community139._ModuleSupport;
var radarAreaSeriesOptionsDef = {
  ...
  connectMissingData: import_ag_charts_core46.boolean,
  marker: markerOptionsDefs3,
  label: seriesLabelOptionsDefs12,
  tooltip: tooltipOptionsDefs17,
  ...commonSeriesOptionsDefs18,
  ...import_ag_charts_core46.fillOptionsDef,
  ...import_ag_charts_core46.strokeOptionsDef,
  ...import_ag_charts_core46.lineDashOptionsDef
};
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs19, seriesLabelOptionsDefs: seriesLabelOptionsDefs13, markerOptionsDefs: markerOptionsDefs4, tooltipOptionsDefs: tooltipOptionsDefs18 } = import_ag_charts_community141._ModuleSupport;
var radarLineSeriesOptionsDef = {
  ...
  connectMissingData: import_ag_charts_core47.boolean,
  marker: markerOptionsDefs4,
  label: seriesLabelOptionsDefs13,
  tooltip: tooltipOptionsDefs18,
  ...commonSeriesOptionsDefs19,
  ...import_ag_charts_core47.strokeOptionsDef,
  ...import_ag_charts_core47.lineDashOptionsDef
};

// packages/ag-charts-enterprise/src/series/radar-line/radarLineModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE5 } = import_ag_charts_community142._ModuleSupport.ThemeConstants;
var RadarLineModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var {
  ...
  STRING: STRING18,
  Label: Label13,
  COLOR_GRADIENT: COLOR_GRADIENT15,
  COLOR_PATTERN: COLOR_PATTERN15,
  OR: OR17
...
var { SectorBox: SectorBox3, motion: motion9 } = import_ag_charts_community144._ModuleSupport;
...
var RadialBarSeriesNodeEvent = class extends import_ag_charts_community145._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadialBarSeries = class extends import_ag_charts_community145._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  get defaultShapeStyle() {
    ...
    return {
      ...
      rotation: import_ag_charts_community145._ModuleSupport.toDegrees(angleScale.range[0]) + 90
    };
  }
  nodeFactory() {
    return new Sector5();
  ...
  getItemStyleOverrides(datumId, datum, format, highlighted) {
    ...
    return getShapeStyle17(overrides, this.defaultShapeStyle, this.properties.fillPatternDefaults);
  }
  updateSectorSelection(selection, highlighted) {
    let selectionData = [];
    if (highlighted) {
    ...
    selection.update(selectionData, void 0, (datum) => this.getDatumId(datum)).each((node, nodeDatum) => {
      ...
      const fill = overrides?.fill ?? style.fill;
      const fillParams = import_ag_charts_community145._ModuleSupport.isGradientFill(fill) && fill.bounds !== "item" ? { centerX: 0, centerY: 0 } : void 0;
  ...
  getTooltipContent(datumIndex) {
    const { id: seriesId, dataModel, processedData, axes, properties } = this;
    const { angleKey, angleName, radiusKey, radiusName, tooltip } = properties;
    const angleAxis = axes[ChartAxisDirection17.X];
    const radiusAxis = axes[ChartAxisDirection17.Y];
    if (!dataModel || !processedData || !angleAxis || !radiusAxis)
      return;
    const datum = processedData.dataSources.get(this.id)?.[datumIndex];
  ...
  legendItemSymbol() {
    const { fill, stroke, fillOpacity, strokeOpacity, strokeWidth, lineDash, lineDashOffset, fillPatternDefaults: fillPatternDefaults4 } = this.properties;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs20, seriesLabelOptionsDefs: seriesLabelOptionsDefs14, tooltipOptionsDefs: tooltipOptionsDefs19 } = import_ag_charts_community146._ModuleSupport;
var radialBarSeriesOptionsDef = {
  ...
  cornerRadius: import_ag_charts_core49.positiveNumber,
  itemStyler: import_ag_charts_core49.callback,
  label: seriesLabelOptionsDefs14,
  tooltip: tooltipOptionsDefs19,
  ...commonSeriesOptionsDefs20,
  ...import_ag_charts_core49.fillOptionsDef,
  ...import_ag_charts_core49.strokeOptionsDef,
  ...import_ag_charts_core49.lineDashOptionsDef
};
...
var RADIAL_BAR_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: import_ag_charts_community147._ModuleSupport.FILL_PATTERN_DEFAULTS,
    strokeWidth: 0,
    label: {
      enabled: false,
      fontSize: { $ref: "fontSize" },
...
// packages/ag-charts-enterprise/src/series/radial-bar/radialBarModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE7 } = import_ag_charts_community148._ModuleSupport.ThemeConstants;
var RadialBarModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { TempValidate: TempValidate35, RATIO: RATIO25 } = import_ag_charts_community149._ModuleSupport;
var RadialColumnSeriesProperties = class extends RadialColumnSeriesBaseProperties {
};
__decorateClass([
  TempValidate35(RATIO25, { optional: true })
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection18, PolarAxis: PolarAxis4, RadialColumnShape, getRadialColumnWidth } = import_ag_charts_community150._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs21, seriesLabelOptionsDefs: seriesLabelOptionsDefs15, tooltipOptionsDefs: tooltipOptionsDefs20 } = import_ag_charts_community151._ModuleSupport;
var radialColumnSeriesOptionsDef = {
  ...
  cornerRadius: import_ag_charts_core50.positiveNumber,
  columnWidthRatio: import_ag_charts_core50.ratio,
  maxColumnWidthRatio: import_ag_charts_core50.ratio,
  itemStyler: import_ag_charts_core50.callback,
  label: seriesLabelOptionsDefs15,
  tooltip: tooltipOptionsDefs20,
  ...commonSeriesOptionsDefs21,
  ...import_ag_charts_core50.fillOptionsDef,
  ...import_ag_charts_core50.strokeOptionsDef,
  ...import_ag_charts_core50.lineDashOptionsDef
};
...
var RADIAL_COLUMN_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: import_ag_charts_community152._ModuleSupport.FILL_PATTERN_DEFAULTS,
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE9 } = import_ag_charts_community153._ModuleSupport.ThemeConstants;
...
var { SvgPath, Rotatable, Translatable, Scalable } = import_ag_charts_community154._ModuleSupport;
...
var {
  ...
  UNION: UNION9,
  AND: AND9,
  LESS_THAN: LESS_THAN4,
  GREATER_THAN: GREATER_THAN4,
  Label: Label14
...
__decorateClass([
  TempValidate36(NUMBER13, { optional: true })
...
__decorateClass([
  TempValidate36(LINE_DASH21)
], RadialGaugeBarProperties.prototype, "lineDash", 2);
__decorateClass([
  TempValidate36(POSITIVE_NUMBER24)
...
__decorateClass([
  TempValidate36(AND9(NUMBER13, LESS_THAN4("max")))
], RadialGaugeScaleProperties.prototype, "min", 2);
__decorateClass([
  TempValidate36(AND9(NUMBER13, GREATER_THAN4("min")))
...
var RadialGaugeSeriesProperties = class extends SeriesProperties12 {
  ...
  isValid(warningPrefix) {
    ...
    if (outerRadius == null !== (innerRadius == null)) {
      import_ag_charts_core51.Logger.warnOnce("Either [innerRadius] and [outerRadius] must both be set, or neither can be set.");
      return false;
    }
    return true;
  }
...
__decorateClass([
  TempValidate36(COLOR_STRING_ARRAY11)
...
__decorateClass([
  TempValidate36(FUNCTION16, { optional: true })
...
var { SectorBox: SectorBox5 } = import_ag_charts_community156._ModuleSupport;
...
} = import_ag_charts_community157._ModuleSupport;
...
var RadialGaugeSeries = class extends import_ag_charts_community157._ModuleSupport.Series {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
    ...
    this.tickSelection = Selection14.select(this.tickGroup, import_ag_charts_community157._ModuleSupport.TransformableText);
    this.datumUnion = new DatumUnion();
  ...
  layoutScale() {
    ...
    const tickData = ticks.map((value, index) => {
      const text = label.formatter?.({ value, index, domain: scale.domain, boundSeries: void 0 }) ?? tickFormatter(value);
  ...
  getShapeFillBBox() {
    ...
    return new BBox15(centerX - radius, centerY - radius, 2 * radius, 2 * radius);
  }
  getTargets() {
    const { properties } = this;
    const defaultTarget = properties.defaultTarget;
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((sector, datum) => {
      ...
      sector.pointerEvents = this.properties.bar.enabled ? import_ag_charts_community157._ModuleSupport.PointerEvents.All : import_ag_charts_community157._ModuleSupport.PointerEvents.None;
      sector.fill = fill;
    ...
    this.datumUnion.update(datumSelection, this.itemGroup, import_ag_charts_community157._ModuleSupport.Sector, (node, first, last) => {
      ...
      node.pointerEvents = import_ag_charts_community157._ModuleSupport.PointerEvents.None;
    });
  }
  updateScaleSelection(opts) {
    return opts.scaleSelection.update(opts.scaleData, void 0, (datum) => {
  ...
  updateTickNodes(opts) {
    ...
    const { enabled, color: color16, fontFamily, fontSize, fontStyle, fontWeight, spacing } = properties.scale.label;
...
// packages/ag-charts-enterprise/src/series/radial-gauge/radialGaugeSeriesOptionsDef.ts
var import_ag_charts_community158 = require("ag-charts-community");
var import_ag_charts_core53 = require("ag-charts-core");
var {
  commonSeriesOptionsDefs: commonSeriesOptionsDefs22,
  autoSizedLabelOptionsDefs: autoSizedLabelOptionsDefs4,
  seriesLabelOptionsDefs: seriesLabelOptionsDefs16,
  tooltipOptionsDefs: tooltipOptionsDefs21,
  numberFormatValidator: numberFormatValidator4
} = import_ag_charts_community158._ModuleSupport;
var radialGaugeTargetOptionsDef = {
  value: (0, import_ag_charts_core53.required)(import_ag_charts_core53.number),
  text: import_ag_charts_core53.string,
  shape: (0, import_ag_charts_core53.or)(
    (0, import_ag_charts_core53.union)("circle", "cross", "diamond", "heart", "plus", "pin", "square", "star", "triangle", "line"),
    import_ag_charts_core53.callback
  ),
  placement: (0, import_ag_charts_core53.union)("inside", "outside", "middle"),
  spacing: import_ag_charts_core53.positiveNumber,
  size: import_ag_charts_core53.positiveNumber,
  rotation: import_ag_charts_core53.number,
  label: {
    ...seriesLabelOptionsDefs16,
    spacing: import_ag_charts_core53.positiveNumber
  },
  ...import_ag_charts_core53.fillOptionsDef,
  ...import_ag_charts_core53.strokeOptionsDef,
  ...import_ag_charts_core53.lineDashOptionsDef
};
var radialGaugeSeriesOptionsDef = {
  type: (0, import_ag_charts_core53.required)((0, import_ag_charts_core53.constant)("radial-gauge")),
  value: (0, import_ag_charts_core53.required)(import_ag_charts_core53.number),
  outerRadius: import_ag_charts_core53.positiveNumber,
  innerRadius: import_ag_charts_core53.positiveNumber,
  outerRadiusRatio: import_ag_charts_core53.ratio,
  innerRadiusRatio: import_ag_charts_core53.ratio,
  startAngle: import_ag_charts_core53.number,
  endAngle: import_ag_charts_core53.number,
  spacing: import_ag_charts_core53.positiveNumber,
  cornerMode: (0, import_ag_charts_core53.union)("container", "item"),
  cornerRadius: import_ag_charts_core53.positiveNumber,
  scale: {
    min: (0, import_ag_charts_core53.and)(import_ag_charts_core53.number, (0, import_ag_charts_core53.lessThan)("max")),
    max: (0, import_ag_charts_core53.and)(import_ag_charts_core53.number, (0, import_ag_charts_core53.greaterThan)("min")),
    label: {
      enabled: import_ag_charts_core53.boolean,
      formatter: import_ag_charts_core53.callback,
      rotation: import_ag_charts_core53.number,
      spacing: import_ag_charts_core53.positiveNumber,
      minSpacing: import_ag_charts_core53.positiveNumber,
      avoidCollisions: import_ag_charts_core53.boolean,
      format: numberFormatValidator4,
      ...import_ag_charts_core53.fontOptionsDef
    },
    interval: {
      values: (0, import_ag_charts_core53.arrayOf)(import_ag_charts_core53.number),
      step: import_ag_charts_core53.number
    },
    ...fillsOptionsDef,
    ...import_ag_charts_core53.fillOptionsDef,
    ...import_ag_charts_core53.strokeOptionsDef,
  ...
  targets: (0, import_ag_charts_core53.arrayOfDefs)(radialGaugeTargetOptionsDef, "target options array"),
  segmentation: {
    enabled: import_ag_charts_core53.boolean,
    spacing: import_ag_charts_core53.positiveNumber,
    interval: {
      values: (0, import_ag_charts_core53.arrayOf)(import_ag_charts_core53.number),
      step: import_ag_charts_core53.number,
      count: import_ag_charts_core53.number
    }
  },
  bar: {
    enabled: import_ag_charts_core53.boolean,
  ...
  needle: {
    enabled: import_ag_charts_core53.boolean,
    spacing: import_ag_charts_core53.positiveNumber,
    radiusRatio: import_ag_charts_core53.ratio,
    ...import_ag_charts_core53.fillOptionsDef,
    ...import_ag_charts_core53.strokeOptionsDef,
    ...import_ag_charts_core53.lineDashOptionsDef
  },
  label: {
    text: import_ag_charts_core53.string,
    spacing: import_ag_charts_core53.positiveNumber,
    ...autoSizedLabelOptionsDefs4
  },
  secondaryLabel: {
    text: import_ag_charts_core53.string,
    ...autoSizedLabelOptionsDefs4
  },
  tooltip: tooltipOptionsDefs21,
  ...commonSeriesOptionsDefs22
};
radialGaugeSeriesOptionsDef.defaultColorRange = (0, import_ag_charts_core53.arrayOf)(import_ag_charts_core53.color);
radialGaugeSeriesOptionsDef.defaultTarget = {
  ...radialGaugeTargetOptionsDef,
  value: import_ag_charts_core53.number,
  label: {
    ...seriesLabelOptionsDefs16,
    spacing: import_ag_charts_core53.number
  }
};
radialGaugeSeriesOptionsDef.scale.defaultFill = import_ag_charts_core53.color;

// packages/ag-charts-enterprise/src/series/radial-gauge/radialGaugeModule.ts
var { FONT_SIZE_RATIO } = import_ag_charts_community159._ModuleSupport;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $interpolate: [{ $palette: "secondDivergingColors" }, 5] },
          import_ag_charts_community159._ModuleSupport.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        defaultFill: { $path: ["./1", { $palette: "fill" }, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        stroke: { $path: ["./2", import_ag_charts_community159._ModuleSupport.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        label: {
          fontWeight: { $ref: "fontWeight" },
          fontSize: { $ref: "fontSize" },
...
var { BBox: BBox16, Path: Path11, ScenePathChangeDetection: ScenePathChangeDetection6, splitBezier } = import_ag_charts_community160._ModuleSupport;
...
var SankeyLink = class extends Path11 {
  ...
  computeBBox() {
    ...
    return new BBox16(x, y, width, height);
  }
  updatePath() {
...
var {
  ...
  OR: OR18,
  COLOR_GRADIENT: COLOR_GRADIENT16,
  COLOR_PATTERN: COLOR_PATTERN16,
  RATIO: RATIO27,
  STRING: STRING20,
  UNION: UNION10,
  TempValidate: TempValidate37,
  Label: Label15
...
__decorateClass([
  TempValidate37(POSITIVE_NUMBER25)
...
__decorateClass([
  TempValidate37(OR18(COLOR_GRADIENT16, COLOR_STRING24), { optional: true })
], SankeySeriesLinkProperties.prototype, "fill", 2);
__decorateClass([
  TempValidate37(RATIO27)
], SankeySeriesLinkProperties.prototype, "fillOpacity", 2);
__decorateClass([
  TempValidate37(COLOR_STRING24, { optional: true })
...
__decorateClass([
  TempValidate37(ARRAY8, { optional: true })
], SankeySeriesProperties.prototype, "nodes", 2);
__decorateClass([
  TempValidate37(STRING20)
...
__decorateClass([
  TempValidate37(STRING20, { optional: true })
...
var SankeySeries = class extends FlowProportionSeries {
  ...
  createNodeData() {
    ...
    if (hasNegativeNodeHeight) {
      import_ag_charts_core54.Logger.warnOnce(
  ...
  getNodeStyleOverrides(datumId, datum, datumIndex, size, label, format, highlighted) {
    ...
    const fill = format.fill ?? fills[datumIndex % fills.length];
    const stroke = format.stroke ?? strokes[datumIndex % strokes.length];
    const defaultColorStops = defaultColorRange[datumIndex % defaultColorRange.length].map((color16) => ({ color: color16 }));
  ...
  updateNodeNodes(opts) {
    ...
    datumSelection.each((rect, datum) => {
      ...
      applyShapeStyle12(rect, style, overrides, fillBBox);
    });
  }
  getShapeFillBBox() {
    const width = this._nodeDataDependencies?.seriesRectWidth ?? 0;
    const height = this._nodeDataDependencies?.seriesRectHeight ?? 0;
    const bbox = new BBox17(0, 0, width, height);
    return { series: bbox, axis: bbox };
  }
  updateLinkSelection(opts) {
    return opts.datumSelection.update(
  ...
  updateLinkNodes(opts) {
    ...
    datumSelection.each((link, datum) => {
      ...
      applyShapeStyle12(link, style, overrides, fillBBox);
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs23, seriesLabelOptionsDefs: seriesLabelOptionsDefs17, tooltipOptionsDefs: tooltipOptionsDefs22 } = import_ag_charts_community163._ModuleSupport;
var sankeySeriesOptionsDef = {
  type: (0, import_ag_charts_core55.required)((0, import_ag_charts_core55.constant)("sankey")),
  fromKey: (0, import_ag_charts_core55.required)(import_ag_charts_core55.string),
  toKey: (0, import_ag_charts_core55.required)(import_ag_charts_core55.string),
  sizeKey: import_ag_charts_core55.string,
  sizeName: import_ag_charts_core55.string,
  fills: (0, import_ag_charts_core55.arrayOf)(import_ag_charts_core55.colorUnion),
  strokes: (0, import_ag_charts_core55.arrayOf)(import_ag_charts_core55.color),
  label: {
    ...seriesLabelOptionsDefs17,
    spacing: import_ag_charts_core55.positiveNumber
  },
  link: {
    itemStyler: import_ag_charts_core55.callback,
    ...import_ag_charts_core55.fillOptionsDef,
    ...import_ag_charts_core55.strokeOptionsDef,
    ...import_ag_charts_core55.lineDashOptionsDef
  },
  node: {
    width: import_ag_charts_core55.positiveNumber,
    spacing: import_ag_charts_core55.positiveNumber,
    alignment: (0, import_ag_charts_core55.union)("left", "center", "right", "justify"),
    itemStyler: import_ag_charts_core55.callback,
    ...import_ag_charts_core55.fillOptionsDef,
    ...import_ag_charts_core55.strokeOptionsDef,
    ...import_ag_charts_core55.lineDashOptionsDef
  },
  tooltip: tooltipOptionsDefs22,
  ...commonSeriesOptionsDefs23
};
...
sankeySeriesOptionsDef.defaultColorRange = (0, import_ag_charts_core55.arrayOf)((0, import_ag_charts_core55.arrayOf)(import_ag_charts_core55.color));
sankeySeriesOptionsDef.defaultPatternFills = (0, import_ag_charts_core55.arrayOf)(import_ag_charts_core55.color);
...
var SankeyModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      fillPatternDefaults: import_ag_charts_community164._ModuleSupport.FILL_PATTERN_DEFAULTS,
      defaultColorRange: { $palette: "gradients" },
      defaultPatternFills: import_ag_charts_community164._ModuleSupport.SAFE_FILLS_OPERATION,
      highlightStyle: {
        series: {
          dimOpacity: 0.2
        }
...
__decorateClass([
  TempValidate38(RATIO28)
], SunburstSeriesProperties.prototype, "fillOpacity", 2);
__decorateClass([
  TempValidate38(POSITIVE_NUMBER26)
...
var SunburstNode = class extends import_ag_charts_community166._ModuleSupport.HierarchyNode {
  constructor() {
    super(...arguments);
    this.label = void 0;
...
var SunburstSeries = class extends import_ag_charts_community166._ModuleSupport.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  getItemStyleOverrides(datumId, datum, depth, colorValue, format, highlighted) {
    ...
    return getShapeStyle19(overrides, this.properties.fillGradientDefaults, this.properties.fillPatternDefaults);
  }
  updateNodes() {
    ...
    const seriesFillBBox = {
      series: new BBox18(-radius, -radius, 2 * radius, 2 * radius),
      axis: new BBox18(-radius, -radius, 2 * radius, 2 * radius)
    };
    ...
    const updateSector = (nodeDatum, sector, style, highlighted) => {
      ...
      const fillBBox = import_ag_charts_community166._ModuleSupport.isGradientFill(fill) && fill.bounds !== "item" ? seriesFillBBox : void 0;
      applyShapeStyle13(sector, style, overrides, fillBBox);
      sector.centerX = 0;
      sector.centerY = 0;
  ...
  getTooltipContent(datumIndex) {
    ...
    if (import_ag_charts_community166._ModuleSupport.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
    return tooltip.formatTooltip(
      properties,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs24, autoSizedLabelOptionsDefs: autoSizedLabelOptionsDefs5, tooltipOptionsDefs: tooltipOptionsDefs23, without: without6 } = import_ag_charts_community167._ModuleSupport;
var sunburstSeriesOptionsDef = {
  type: (0, import_ag_charts_core56.required)((0, import_ag_charts_core56.constant)("sunburst")),
  labelKey: import_ag_charts_core56.string,
  secondaryLabelKey: import_ag_charts_core56.string,
  childrenKey: import_ag_charts_core56.string,
  sizeKey: import_ag_charts_core56.string,
  colorKey: import_ag_charts_core56.string,
  sizeName: import_ag_charts_core56.string,
  colorName: import_ag_charts_core56.string,
  fills: (0, import_ag_charts_core56.arrayOf)(import_ag_charts_core56.colorUnion),
  strokes: (0, import_ag_charts_core56.arrayOf)(import_ag_charts_core56.color),
  colorRange: (0, import_ag_charts_core56.arrayOf)(import_ag_charts_core56.color),
  sectorSpacing: import_ag_charts_core56.positiveNumber,
  cornerRadius: import_ag_charts_core56.positiveNumber,
  padding: import_ag_charts_core56.positiveNumber,
  itemStyler: import_ag_charts_core56.callback,
  label: {
    spacing: import_ag_charts_core56.positiveNumber,
    ...autoSizedLabelOptionsDefs5
  },
  secondaryLabel: autoSizedLabelOptionsDefs5,
  tooltip: tooltipOptionsDefs23,
  ...commonSeriesOptionsDefs24,
  ...without6(import_ag_charts_core56.fillOptionsDef, ["fill"]),
  ...without6(import_ag_charts_core56.strokeOptionsDef, ["stroke"]),
  highlightStyle: {
    label: {
      color: import_ag_charts_core56.color
    },
    secondaryLabel: {
      color: import_ag_charts_core56.color
    },
    ...import_ag_charts_core56.fillOptionsDef,
    ...import_ag_charts_core56.strokeOptionsDef
  }
};

// packages/ag-charts-enterprise/src/series/sunburst/sunburstModule.ts
var { FONT_SIZE_RATIO: FONT_SIZE_RATIO2 } = import_ag_charts_community168._ModuleSupport;
var SunburstModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
      ...
      fillPatternDefaults: import_ag_charts_community168._ModuleSupport.FILL_PATTERN_DEFAULTS,
      label: {
        fontFamily: { $ref: "fontFamily" },
...
var {
  ...
  COLOR_GRADIENT: COLOR_GRADIENT17,
  COLOR_PATTERN: COLOR_PATTERN17,
  OR: OR19,
  Label: Label16
...
__decorateClass([
  TempValidate39(OR19(COLOR_GRADIENT17, COLOR_STRING26, COLOR_PATTERN17), { optional: true })
], TreemapSeriesGroup.prototype, "fill", 2);
__decorateClass([
  TempValidate39(RATIO29)
], TreemapSeriesGroup.prototype, "fillOpacity", 2);
__decorateClass([
  TempValidate39(COLOR_STRING26, { optional: true })
], TreemapSeriesGroup.prototype, "stroke", 2);
__decorateClass([
  TempValidate39(POSITIVE_NUMBER27)
...
__decorateClass([
  TempValidate39(BOOLEAN12)
], TreemapSeriesGroup.prototype, "interactive", 2);
__decorateClass([
  TempValidate39(OBJECT29)
...
__decorateClass([
  TempValidate39(POSITIVE_NUMBER27, { optional: true })
...
__decorateClass([
  TempValidate39(VERTICAL_ALIGN2)
...
__decorateClass([
  TempValidate39(STRING22, { optional: true })
], TreemapSeriesGroupHighlightStyle.prototype, "fill", 2);
__decorateClass([
  TempValidate39(RATIO29, { optional: true })
...
__decorateClass([
  TempValidate39(FUNCTION19, { optional: true })
...
var TreemapNode = class extends import_ag_charts_community170._ModuleSupport.HierarchyNode {
  constructor() {
    super(...arguments);
...
var DistantGroup = class extends import_ag_charts_community170._ModuleSupport.Group {
  distanceSquared(x, y) {
    return this.getBBox().distanceSquared(x, y);
  }
};
var TreemapSeries = class extends import_ag_charts_community170._ModuleSupport.HierarchySeries {
  constructor() {
    super(...arguments);
    ...
    this.datumSelection = Selection16.select(this.rectGroup, Rect8);
    this.labelSelection = Selection16.select(this.labelGroup, Group18);
  ...
  squarify(node, bbox) {
    ...
    const innerBox = new BBox19(bbox.x + padding.left, bbox.y + padding.top, width, height);
    ...
    while (i < numChildren) {
      ...
      const ratio10 = Math.max(firstTileLength, stackThickness) / Math.min(firstTileLength, stackThickness);
      const diff8 = Math.abs(targetTileAspectRatio - ratio10);
      ...
      for (let j = startIndex; j < i; j++) {
        ...
        const childBbox = new BBox19(x, y, stackWidth, stackHeight);
    ...
    for (let childIdx = startIndex; childIdx < numChildren; childIdx++) {
      ...
      const childBox = new BBox19(x, y, childWidth, childHeight);
  ...
  applyGap(innerBox, childBox, allLeafNodes) {
    ...
    sides.forEach((side) => {
      if (!(0, import_ag_charts_core57.isNumberEqual)(innerBounds[side], childBounds[side])) {
  ...
  getGroupStyleOverrides(datumId, datum, depth, format, highlighted) {
    ...
    return getShapeStyle20(overrides, this.properties.fillGradientDefaults, this.properties.fillPatternDefaults);
  }
  ...
  updateNodes() {
    ...
    const { width, height } = seriesRect;
    this.squarify(rootNode, new BBox19(0, 0, width, height));
    this.rootNode?.walk((node) => {
    ...
    const fillBBox = {
      series: new BBox19(0, 0, width, height),
      axis: new BBox19(0, 0, width, height)
    };
    const updateRectFn = (node, rect, groupStyle, tileStyle, highlighted) => {
      ...
      rect.crisp = true;
      applyShapeStyle14(rect, style, overrides, fillBBox);
  ...
  getTooltipContent(datumIndex) {
    ...
    if (import_ag_charts_community170._ModuleSupport.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs25, seriesLabelOptionsDefs: seriesLabelOptionsDefs18, tooltipOptionsDefs: tooltipOptionsDefs24 } = import_ag_charts_community171._ModuleSupport;
var treemapSeriesOptionsDef = {
  type: (0, import_ag_charts_core58.required)((0, import_ag_charts_core58.constant)("treemap")),
  labelKey: import_ag_charts_core58.string,
  secondaryLabelKey: import_ag_charts_core58.string,
  childrenKey: import_ag_charts_core58.string,
  sizeKey: import_ag_charts_core58.string,
  colorKey: import_ag_charts_core58.string,
  sizeName: import_ag_charts_core58.string,
  colorName: import_ag_charts_core58.string,
  fills: (0, import_ag_charts_core58.arrayOf)(import_ag_charts_core58.colorUnion),
  strokes: (0, import_ag_charts_core58.arrayOf)(import_ag_charts_core58.color),
  colorRange: (0, import_ag_charts_core58.arrayOf)(import_ag_charts_core58.color),
  itemStyler: import_ag_charts_core58.callback,
  group: {
    gap: import_ag_charts_core58.positiveNumber,
    padding: import_ag_charts_core58.positiveNumber,
    cornerRadius: import_ag_charts_core58.positiveNumber,
    textAlign: (0, import_ag_charts_core58.union)("left", "center", "right"),
    interactive: import_ag_charts_core58.boolean,
    label: {
      ...seriesLabelOptionsDefs18,
      spacing: import_ag_charts_core58.positiveNumber
    },
    ...import_ag_charts_core58.fillOptionsDef,
    ...import_ag_charts_core58.strokeOptionsDef
  },
  tile: {
    gap: import_ag_charts_core58.positiveNumber,
    padding: import_ag_charts_core58.positiveNumber,
    cornerRadius: import_ag_charts_core58.positiveNumber,
    textAlign: (0, import_ag_charts_core58.union)("left", "center", "right"),
    verticalAlign: (0, import_ag_charts_core58.union)("top", "middle", "bottom"),
    label: {
      ...seriesLabelOptionsDefs18,
      spacing: import_ag_charts_core58.positiveNumber,
      lineHeight: import_ag_charts_core58.positiveNumber,
      minimumFontSize: import_ag_charts_core58.positiveNumber,
      wrapping: (0, import_ag_charts_core58.union)("never", "always", "hyphenate", "on-space"),
      overflowStrategy: (0, import_ag_charts_core58.union)("ellipsis", "hide")
    },
    secondaryLabel: {
      ...seriesLabelOptionsDefs18,
      lineHeight: import_ag_charts_core58.positiveNumber,
  ...
  tooltip: tooltipOptionsDefs24,
  ...commonSeriesOptionsDefs25,
  highlightStyle: {
    group: {
      label: {
        color: import_ag_charts_core58.color
      },
      ...import_ag_charts_core58.fillOptionsDef,
      ...import_ag_charts_core58.strokeOptionsDef
    },
...
treemapSeriesOptionsDef.fillGradientDefaults = import_ag_charts_core58.fillGradientDefaults;
treemapSeriesOptionsDef.fillPatternDefaults = import_ag_charts_core58.fillPatternDefaults;
treemapSeriesOptionsDef.undocumentedGroupFills = (0, import_ag_charts_core58.arrayOf)(import_ag_charts_core58.color);
treemapSeriesOptionsDef.undocumentedGroupStrokes = (0, import_ag_charts_core58.arrayOf)(import_ag_charts_core58.color);

// packages/ag-charts-enterprise/src/series/treemap/treemapModule.ts
var { FONT_SIZE_RATIO: FONT_SIZE_RATIO3 } = import_ag_charts_community172._ModuleSupport;
var TreemapModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
      ...
      fillPatternDefaults: import_ag_charts_community172._ModuleSupport.FILL_PATTERN_DEFAULTS,
...
// packages/ag-charts-enterprise/src/main-modules.ts
var ModuleRegistry = import_ag_charts_community173._ModuleSupport.ModuleRegistry;
